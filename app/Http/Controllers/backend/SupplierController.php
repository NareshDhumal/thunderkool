...
class SupplierController extends Controller
{
    ...
    public function store(request $request)
    {
        ...
        $this->validate($request, [
            ...
            's_email' => 'nullable|email|regex:/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/ix|unique:supplier,s_email',
            's_mobile_no' => 'required|digits:10|regex:/^[6-9]{1}[0-9]{9}$/',
            's_address' => 'required',
            // 's_gstno' => 'required',
            's_pin_code' => 'required|numeric|digits:6',
            's_state' => 'required',
            // 's_bank_name' => 'required',
            // 's_branch_name' => 'required',
            's_account_no' => 'nullable|numeric',
    ...
    public function update(request $request)
    {
        $this->validate($request, [
            's_name' => 'required|regex:/^[a-zA-Z\s]*$/',
            's_email' => 'nullable|email|regex:/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/ix',
            's_mobile_no' => 'required|digits:10||regex:/^[6-9]{1}[0-9]{9}$/',
            's_address' => 'required',
            // 's_gstno' => 'required',
            's_pin_code' => 'required|numeric|digits:6',
