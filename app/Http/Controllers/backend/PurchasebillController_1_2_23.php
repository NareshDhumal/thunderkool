...
class PurchasebillController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.purchasebill.create', compact('supplier', 'comapany', 'gst_percent', 'products', 'data', 'payment_mode', 'p_unit', 'all_product'));
    }
        ...
        if ($final_purchase_bill->save()) {
            for ($i = 0; $i < count($request->product_name); $i++) {
                ...
                if ($request->supplier_state == '21') {
                    ...
                    $purchase_bill_sgst_percent = '';
                    $purchase_bill_cgst_percent = '';

                    $purchase_bill_igst_total = $request->final_igst_amount;
                    $purchase_bill_sgst_total = '';
                    $purchase_bill_cgst_total = '';
                }
    ...
    public function update(request $request)
    {
        ...
        if (isset($purchase_bill)) {
            $electronic_ref_no = $request->electronic_payment_ref;
            $purchase_bill->electronic_transaction_ref = $electronic_ref_no;
    ...
    {
        // dd($request->all);
        return view('backend.purchasebill.testform');
    }
