...
class ReportsController extends Controller
{
    ...
    public function Purchasereports(Request $request)
    {
        ...
        //     $purcase_reports = Finalpurchasebill::with('company', 'supplier', 'Product_details')->whereDate('created_at', '>=', $startDate)->whereDate('created_at', '<=', $endDate)->get();

        //     // dd($purcase_reports->toArray());

        //     // $purcase_reports = Finalpurchasebill::with('company', 'supplier', 'Product_details')->where('company_id', $request->company_id)->orWhere('supplier_id', $request->supplier_id)->whereDate('created_at', '>=', $startDate)->whereDate('created_at', '<=', $endDate)->get();
        ...
        // if (isset($request->company_id) || isset($request->supplier_id)) {


        //     $purcase_reports = Finalpurchasebill::with('company', 'supplier', 'Product_details')->where('company_id', $request->company_id)->orWhere('supplier_id', $request->supplier_id)->get();
