                ...
                if (isset($request->product_row_counter)) {
                    ...
                    foreach ($request->product_row_counter as $product_row_count) {
                        ...
                        if ($request->$p_unit == '1') {
                            ...
                            $product->product_stock = (int)$product->product_stock - (int)$request->$quantity * 1000;
                        }
                        $product->save();
                ...
                for ($i = 0; $i < $request->row_count; $i++) {
                    ...
                    if (isset($request->$previous_quantity)) {
                        ...
                        if ($request->$p_unit == '1') {
                            ...
                            $product->product_stock = (int)$product->product_stock + $request->$previous_quantity * 1000;
                        } else if ($request->$p_unit == '5') {
                            $product->product_stock = (int)$product->product_stock + (int)$request->$previous_quantity * 1000;
                        }
                        $product->save();
                    }
