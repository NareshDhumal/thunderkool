...
class DummyinvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // }
            ...
            //     $product_name = Product::where('product_id',$product['product_description'])->first();
            // }
   

        return view('backend.dummyinvoice.view', compact('invoice_data', 'company_details', 'vehicle_make', 'vehicle_model', 'customers', 'vehicle','products'));
    }
