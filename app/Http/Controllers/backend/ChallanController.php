...
class ChallanController extends Controller
{
    ...
    public function store(request $request)
    {
        ...
        if ($request->gst_flag == 0) {
            ...
            $challan->base_amount = $request->cwg_total_amount_all_without_gst;
            ...
            foreach ($request->product_row_counter as $product_row_count) {
                ...
                $productChallan->orignal_amt = $request->$orignal_amt;
                $productChallan->orignal_hidden_rate = $request->$orignal_hidden_rate;
    ...
    public function edit($id)
    {
        ...
        $products = Product::whereIn('company_id', [$challan->company_id, 1])->get();
