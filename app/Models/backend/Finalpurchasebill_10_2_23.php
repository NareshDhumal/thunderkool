...
class Finalpurchasebill extends Model
{
    ...
    protected $fillable = ['supplier_id', 'company_id', 'supplier_bill_no', 'dated', 'payment_mode', 'cheque_no', 'electronic_payment_ref', 'bank_name', 'cheque_date', 'flag', 'gst_flag', 'type', 'amount_words', 'invoice_no','financial_year'];
