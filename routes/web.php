...
use App\Http\Controllers\backend\DailyexpenseController;
...
use App\Http\Controllers\backend\VehiclerelationController;
...
Route::group(['prefix' => 'admin'], function () {
  Route::group(['middleware' => 'admin.guest'], function () {
    ...
    // Route::get('/forgetpassword', [AdminController::class, 'forgetpassword'])->name('admin.login.forgetpassword');
  ...
  Route::group(['middleware' => 'admin.auth'], function () {
    ...
    //vechlemodel
    Route::get('/vehiclemodel/{id}', [VehiclemodalController::class, 'index'])->name('admin.vehiclemodel');
    Route::get('/vehicle/addmodel/{id?}', [VehiclemodalController::class, 'addmodel'])->name('admin.vehiclemodel.addmodel');
    ...
    Route::get('/vehicle/{id}', [VehicleController::class, 'index'])->name('admin.vehicle');

    Route::get('/vehicle/addvehicle/{id}', [VehicleController::class, 'addvehicle'])->name('admin.vehicle.addvehicle');
    ...
    // ajax call 
    Route::post('/vehicle/vehiclemodel', [VehicleController::class, 'model'])->name('admin.vehicle.model');
    // Route::post('/vehicle/vehiclemodeledit', [VehicleController::class, 'modeledit'])->name('admin.vehicle.modeledit');
    ...
    Route::post('/purchase/bill/getproducts', [PurchasebillController::class, 'getproducts'])->name('admin.purchasebill.getproducts');
    ...
    //Invoice search by vehicle nad customer
    Route::get('/invoice/vehicle/customerreport', [ReportsController::class, 'vehicle_customerreports'])->name('admin.vehicle.customerreports');

    //customer wise product report
    // Route::get('/invoice/customer/productreport', [ReportsController::class, 'customer_productreports'])->name('admin.customer.productreport');

    //purchase bill supllier wise
    Route::get('purchasebill/supplierreport', [ReportsController::class, 'purchasebill_supplierreport'])->name('admin.purchasebill.supplierreport');
    ...
    Route::get('/multiview', [InvoiceController::class, 'multiview'])->name('admin.invoice.multiview');
    ...
    // costomer and vehicle relation
    // Route::get('/vehicle/addvehicle/{id}', [VehiclerelationController::class, 'create'])->name('admin.relation.create');
    Route::post('/addvehicle/store', [VehiclerelationController::class, 'store'])->name('admin.relation.store');
    // ajax call 
    // Route::post('/vehicle/vehiclemodel', [VehiclerelationController::class, 'model'])->name('admin.vehicle.model');



    //Daily Expense Management 
    Route::get('/dailyexpenses', [DailyexpenseController::class, 'index'])->name('admin.dailyexpenses');
    Route::post('/dailyexpenses/store', [DailyexpenseController::class, 'store'])->name('admin.dailyexpenses.store');
    Route::get('/dailyexpenses/delete/{id}', [DailyexpenseController::class, 'delete'])->name('admin.dailyexpenses.delete');
