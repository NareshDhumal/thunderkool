                    ...
                    <div class="feedback-form">
                        <form>
                            ...
                            <label id="first" class="is-visible">
                                ...
                                <label class="label-heading" for="first">What do you think of our monthly
                                    newsletter?</label>
                                <p class="label-subheading">
                                    Give us your feedback and help us improve
                                </p>
                                <input name="first" type="text" value="first" placeholder="name" required />
                                ...
                                <div class="arrow-div">
                                    <i class="fa fa-angle-right" onclick="next('first','second')"></i>
                                </div>
                            </label>
                            <!-- End First Slide -->
                            ...
                            <label id="second">
                                ...
                                <label class="label-heading first_question" for="second">1</label>
