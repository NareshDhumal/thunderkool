    ...
    <script>
        $(document).ready(function() {
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                // data +=
                //     '<td>{{ Form::select('cgst_percent[]', $gst_percent, null, ['class' => 'from-control gst_percent', 'placeholder' => 'Gst', 'id' => 'gst_percent']) }}</td>';
                ...
                $('.product_name').on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#hsn_code" + test).val(return_data['hsn_code']);
                            $("#product_rate_" + test).val(return_data['product_rate']);
            ...
            $(document).on('change', '.quentity', function() {
                ...
                var product_rate = $('#product_rate_' + test).val();
                var product_amount = $('#product_amount' + test).val();
                var gst_percent = $('#gst_percent_' + test).val();


                var unit = $('#unit_' + test).val();
                console.log(unit);
                if (unit == 'Gm') {
                    ...
                    // $('#gst_amount' + test).val(gst_amount);
                    // var row_total_gst = Number(product_amount) + Number(gst_amount);
                    // $("#total_amount" + test).val(row_total_gst);
            ...
            // change amount on quentity change
            // $(document).on('change', '.quentity', function() {
            //     var quentity = $(this).val();
            //     var row_id = $(this).attr('id');
            //     var row_count = row_id.split('_');
            ...
            $(document).on('change', '.gst_percent', function() {
                ...
                var row_count = row_id.split('_');
                var test = row_count[2];
                var amount_data = $('#product_amount' + test).val();
