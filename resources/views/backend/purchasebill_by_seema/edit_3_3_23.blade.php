                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::Select('supplier_id', $supplier, $data->supplier_id, ['class' => 'form-control supplier_select', 'placeholder' => 'Select Supplier', 'id' => 'supplier_id', 'required' => true]) }}
                                    ...
                                    {{-- <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::hidden('supplier_bill_no', $all_product+1 ,null, ['class' => 'form-control', 'placeholder' => 'Enter First Name', 'required' => true]) }}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::text('supplier_bill_no', $data->supplier_bill_no,['class' => 'form-control', 'placeholder' => '', 'required' => true]) }}
                                                ...
                                                @foreach ($data->Product_details as $product_detail)
                                                    <tr id="row{{ $loop->iteration - 1 }}">
                                                        ...
                                                        @if ($product_detail->product_unit == 'Nos')
                                                            <th scope="col"><input type="number" name="quantity[]"
                                                        ...
                                                        {{-- new changes --}}
                                                        @if ($product_detail->product_unit == 'Nos')
                                                            <th scope="col"><input type="number" name="grams[]"
                                                                    id="grams_{{ $loop->iteration - 1 }}" value=""
                                                                    data-myval="{{ $loop->iteration - 1 }}"
                                                        ...
                                                        <th scope="col"><input type="number" name="gst_amount[]"
                                                        ...
                                                        <th scope="col"><input type="number" name="total_amount[]"
        ...
        $(document).ready(function() {
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                if (supplier_id == '' || company_id == '') {
                    ...
                    data +=
                        '<td><input type="number" name="gst_amount[]"  id="gst_amount' + i +
