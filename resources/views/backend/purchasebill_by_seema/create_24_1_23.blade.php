...
@section('content')
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    {{-- <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#exampleModal" style="width: 100px">Modal</button>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {{ Form::open(['url' => 'admin/purchase/bill/productdetails']) }}
                                                    @csrf
                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-6 col-12">
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-label-group">
                                                                    ...
                                                                    {{ Form::select('company_name', $comapany, null, ['class' => 'form-control', 'placeholder' => 'Enter First Name', 'required' => true]) }}
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" id="submit_product" class="btn btn-primary">save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            //     var value2 = convertNumberToWords(value1);
            ...
            $('#add_btn','#submit_product').on('click', function() {
