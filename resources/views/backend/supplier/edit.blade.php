...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Edit Supplier</h4>
        </div>
    ...
    <section class="db-section admin-form">
      ...
      right: 50px;">
                        <a href="{{ route('admin.supplier') }}" class="btn btn-inverse-danger btn-fw"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
                            ...
                            {{-- <p class="card-description">Edit Supplier</p> --}}
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group mb-5">
                                            {{ Form::hidden('supplier_id', $editdata->supplier_id) }}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::text('s_email', null, ['class' => 'form-control', 'placeholder' => 'Enter Email']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::text('s_gstno', null, ['class' => 'form-control', 'placeholder' => 'Enter Gst No']) }}
                                        </div>
                                    </div>
                          ...
                          {{ Form::text('s_pin_code', null, ['class' => 'form-control', 'placeholder' => 'Enter ', 'required' => true]) }}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::select('s_state', $state_data, null, ['class' => 'form-control state_selection', 'placeholder' => 'Select State', 'required' => true]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::text('s_bank_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Bank Name']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::text('s_branch_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Branch Name']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::text('s_account_no', null, ['class' => 'form-control', 'placeholder' => 'Enter Account Number']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::text('s_bank_ifsc', null, ['class' => 'form-control', 'placeholder' => 'Enter Bank Ifsc']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-5">
                                            ...
                                            {{ Form::text('s_pan_no', null, ['class' => 'form-control', 'placeholder' => 'Enter Pan No']) }}
                                        </div>
                                    </div>
