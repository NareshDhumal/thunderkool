...
@section('title', 'Update Vehicle Make')
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.vehiclemake') }}" class="btn btn-secondary my-2" title="Back" data-bs-toggle="tooltip"><i class="fa fa-arrow-left"></i></a>
        </div>
    </div>
    <!--end::Toolbar-->
