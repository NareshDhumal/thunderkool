                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::Select('supplier_id', $supplier, ['class' => 'form-select supplier_select', 'placeholder' => 'Select Supplier', 'id' => 'yourid', 'required' => true]) }}
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.unit', function() {
                ...
                if (unit == 'Gm' || unit == 'Mil') {
                    ...
                    $('#grams_' + get_id).val('');
                    $('#grams_' + get_id).attr('readonly', true);
                    $('#quantity_' + get_id).attr('readonly', false);
