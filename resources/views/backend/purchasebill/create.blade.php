                    ...
                    <div class="card-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="table-responsive my-5">
                                <table class="table table-bordered w-100" style="width: auto">
                                    <thead>
                                        <tr class="d-flex" style="width:auto">
                                            ...
                                            {{-- <th scope="col" style="width:140px">Comapny Part No</th>
                                                    <th scope="col" style="width:140px">Custom Part No</th> --}}
        ...
        $(document).ready(function() {
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                if (supplier_id == '' || company_id == '') {
                    ...
                    data +=
                        '<td style="width:250px"><select  name="product_name[]" class="form-control product_name" placeholder="select product" id="product_name_' +
                        i + '"></select></td>';

                    data +=
                        '<td style="width:140px"><input type="number" name="hsn_code[]"  id="hsn_code' + i +
                    ...
                    data +=
                        ...
                        i +
                        '"  data-myval="' + i +
                        '" class="form-control orignal_amount" placeholder="Enter amount" readonly></td>';
                    ...
                    // data +=
                    //     '<td style="width:140px"><select  name="group[]" class="form-control group" id="group_' +
                    //     i + '" style="width: 80px">';
                    ...
                    // data +=
                    // '<td style="width:140px"><input type="text" name="kg[]"  id="kg_' + i +
                    // '"  data-myval="' + i +
                    // '" class="form-control kg" placeholder="Enter kg"></td>';
                    // data +=
                    // '<td style="width:140px"><input type="text" name="mil[]"  id="mil_' + i +
                    // '"  data-myval="' + i +
                    // '" class="form-control mil" placeholder="Enter mil"></td>';
                    // data +=
                    // '<td style="width:140px"><input type="text" name="lit[]"  id="lit_' + i +
                    // '"  data-myval="' + i +
                    ...
                    // data += '<td style="width:140px"><button type="button" id="' + i +
                    //     '" class="btn btn-danger remove_row">Delete</button></td>';

                    data += '<td style="width:250px text-align: center; vertical-align: middle;"><li id="' +
                        i +
