...
@section('title', 'View Purchasebill')
        ...
        <div class="card shadow border-0">
            ...
            <div class="card-body">
                <main class="docs-main order-1">
                    ...
                    <form method="post">
                        <div id="table-wraper">
                            <table class="table-bordered tbl-datatable" cellpadding="5" style="">
                                <tr>
                                    <th colspan="15" align="center" class="bold" style="font-size:15px;">PURCHASE</th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" class="bold">Dated:{{ $purchase_bill->dated }}&nbsp;
                                    </td>
                                </tr>

                                <tr>
                                    <td colspan="10" valign="top">Mode/Terms of Payment
                                        <br>{{ $purchase_bill->payment_mode }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="bold" style="width:10mm;">Discount Amt</td>
                                ...
                                @if (isset($purchase_bill->product_details) && count($purchase_bill->product_details) > 0)
                                    ...
                                    @foreach ($purchase_bill->product_details as $product_detail)
                                        @php
                                            $p_id = $product_detail->product_name;
                                            $product = Product::where('product_id', $p_id)->first();
                                        @endphp
                                        <tr class="min_height">
                                            <td align="center">{{ $srno }}</td>
                                            <td width="250" class="fw-bold">{{ $product->product_name }}</td>
                                            <td align="right">{{ $product_detail->hsn_code }}</td>
                                            <td align="right">
                                                {{ $product_detail->quantity . ' ' . $product_detail->product_unit }}</td>
                                            <td align="right">{{ $product_detail->rate }}</td>
                                            <!-- <td align="right"</td> -->

                                            <td align="right" colspan="1" style="width:10mm;">
                                                {{ $product_detail->orignal_amount }}
                                            </td>
                                            <td align="right" style="width:10mm;">

                                                {{ $product_detail->discount != 0 ? $product_detail->discount . ' %' : '-' }}
                                            </td>
                                            <td align="right" colspan="1" style="width:10mm;">
                                            ...
                                            <td align="right" style="width:10mm;">{{ $product_detail->row_total_gst }}
                                            </td>
                                ...
                                <tr>
                                    <td colspan="7" align="right" class="bold">TOTAL</td>
                                    {{-- <td align="right"></td>
                                    <td></td> --}}

                                    <td align="right" colspan="1" class="bold">
                                ...
                                <tr>
                                    ...
                                    <td align="right" colspan="5" style="width:10mm;" class="bold">
                                        {{ $product_detail->total_init_amount }}</td>
                                </tr>
                                <tr>
                                    <td colspan="10" style="text-align: right;" class="bold">IGST</td>
                                    <td colspan="5" style="text-align: right;" class="bold">
                                ...
                                <tr>
                                    <td colspan="10" style="text-align: right;" class="bold">Grand Total (With GST)
                                    </td>
                                    <td colspan="5" style="text-align: right;" class="bold">
                                ...
                                <tr>
                                    <td colspan="15" align="left" class="bold">Amount Chargeable ( in Words
                                        )<br><br><span class="bold">{{ $purchase_bill->amount_words }}</span></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="12" align="right" valign="bottom"><br /><br /><br />
                                        {{ $purchase_bill->company->company_name }}
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="12" align="right">Authorised Signatory</td>
                                </tr>
                            </table>
                        </div>
