...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.purchase.bill') }}" class="btn btn-secondary my-2"><i class="bx bx-plus"></i>Back</a>
        </div>
    </div>
    <!--end::Toolbar-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group mb-5">
                                                ...
                                                <select style="border:2px" class="form-control supplier_select"
                                            ...
                                            <table class="table table-bordered w-100">
                                                <thead>
                                                    ...
                                                    <th scope="col">Total</th> --}}
                                                        ...
                                                        <th>
                                                            <i class="fa-solid fa-plus" id="add_btn"></i>
                                                        </th>
                                                    </tr>
                                                </thead>
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                if (supplier_id == '' || company_id == '') {
                    ...
                    data +=
                        ...
                        '"  data-myval="' + i +
                        '" class="form-control orignal_amount" placeholder="Enter amount" style="width: 80px"></td>';
                    ...
                    data +=
                        '<td><input type="number" name="amount[]"  id="product_amount' + i +
                        '"  data-myval="' + i +
                    ...
                    data += '<td><li id="' + i +
                        '" class="fa-sharp fa-solid fa-trash remove_row"></li></td>';
                ...
                $('.product_name').on('change', function() {
                    ...
                    var unit = $('#orignal_amount' + get_id).val('');
