...
<style>
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.purchase.bill') }}" class="btn btn-secondary my-2" data-bs-toggle="tooltip" title= "Back" ><i class="fa fa-arrow-left"></i></a>
        </div>
    </div>
    <!--end::Toolbar-->
                                ...
                                <div class="form-body">
                                    <div class="row g-5 align-items-end">
                                        ...
                                        <div class="col-12">
                                            <table class="table-bordered " width="100%" style="width:100%">
                                                <tr style="border: 0;">
                                                    <th  colspan="14" style="font-size:15px;text-align: center; border: 0;">Supplier Details</th>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <table class="table-bordered " width="100%" style="width:100%">
                                                <tr style="border: 0;">
                                                    <th  colspan="16" style="font-size:15px;text-align: center; border: 0;">Company Details</th>
                                                </tr>
                                                <tr>
                                    ...
                                    @endif --}}
                                            ...
                                            <table class="table table-bordered w-100">
                                                ...
                                                @if (isset($data->Product_details))
                                                    @foreach ($data->Product_details as $product_detail)
                                                        <tr id="row{{ $row_id = $loop->iteration - 1 }}">
                                                            ...
                                                            <th scope="col"><input type="text" name="hsn_code[]"
                                                                    ...
                                                                    placeholder="Enter hsn code" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"></th>
                                                            ...
                                                            <th scope="col"><input type="number" name="rate[]"
                                                            ...
                                                            @if ($product_detail->product_unit == 'Nos')
                                                                <th scope="col"><input type="float" name="grams[]"
                                                            ...
                                                            <th scope="col"><input type="number"
                                                                    ...
                                                                    placeholder="Enter amount" style="width: 80px" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" readonly></th>

                                                            <th scope="col"><input type="number" name="discount[]"
                                                                    id="discount_{{ $loop->iteration - 1 }}"
                                                                    value="{{ $product_detail->discount }}"
                                                                    class="form-control discount" placeholder="disc"
                                                                    style="width: 80px" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"></th>

                                                            <th scope="col"><input type="number" name="amount[]"
                                                            ...
                                                            <th scope="col"><input type="float" name="gst_amount[]"
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-4 col-12">
                                               Amount 
                                               <input type="text" class="form-control finalamount"
                                               name="finalamount" readonly="readonly">
                                            </div>
                                            <div class="col-md-4 col-12">
                                               Total Amount 
                                               <input type="text"
                                        ...
                                        <div class="col-12 d-flex justify-content-start">
                                            ...
                                            <button type="reset"
                                                class="btn btn-primary mr-1 mb-1">Reset</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                if (supplier_id == '' || company_id == '') {
                    ...
                    data +=
                        ...
                        '"  data-myval="' + i +
                        '" class="form-control orignal_amount" placeholder="Enter amount" style="width: 80px" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" readonly></td>';

                    data +=
                        '<td><input type="number" name="discount[]"  id="discount_' + i +
                        '" class="form-control discount" placeholder="disc" style="width: 80px" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"></td>';

                    data +=
                        '<td><input type="float" name="amount[]"  id="product_amount' + i +
                        '"  data-myval="' + i +
                        '" class="form-control product_amount" placeholder="Enter amount"  style="width: 80px" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"></td>';
