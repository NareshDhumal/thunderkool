...
@section('title', 'Create Purchasebill')
@section('content')
    <style>
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Create Purchase Bill</h4>
        </div>
                        ...
                        <div class="form-body">
                            <div class="row g-5 align-items-end">
                                {{-- <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                ...
                                                {{ Form::Select('supplier_id', $supplier, ['class' => 'form-select supplier_select', 'placeholder' => 'Select Supplier', 'id' => 'supplier_id', 'required' => true]) }}
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <select style="border:2px;" class="form-select supplier_select" name="supplier_id"
                                            id="supplier_id">
                                ...
                                <div class="col-12">
                                    <table class="table-bordered" width="100%" style="width:100%">
                                        <tr style="border: 0;">
                                            <th colspan="14" style="font-size:15px;text-align: center; border: 0;">
                                                Supplier Details</th>
                                        </tr>
                                        <tr>
                                ...
                                {{-- <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                ...
                                                {{ Form::Select('company_id', $comapany, ['class' => 'form-control', 'placeholder' => 'Select Company', 'id'=>'company_id','required' => true]) }}
                                            </div>
                                        </div> --}}
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        <select style="border:2px " class="form-select supplier_select" name="company_id"
                                            id="company_id">
                                            <option value="">Select a Company</option>
                                            @foreach ($comapany as $key => $comapanys)
                                                <option value="{{ $key }}">
                                                    {{ $comapanys }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="col-12">
                                    ...
                                    <table class="table-bordered" width="100%" style="width:100%">
                                        <tr style="border: 0;">
                                            <th colspan="16" style="font-size:15px;text-align: center; border: 0;">Company
                                                Details</th>
                                        </tr>
                                        <tr>
                                            <td colspan="8" style="width: 50%; " class="company_details"></td>
                                            <td colspan="8" style="width: 50%; " class="company_bank_details"></td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <input value="{{ date('Y-m-d') }}" type="date" id="date_of_issue" name="dated"
                                            class="form-control">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{ Form::Select('payment_mode', $payment_mode, null, ['class' => 'form-select payment_mode']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" id="payment_electronic_ref">
                                    <input class="form-control" type="text" name="electronic_payment_ref"
                                        id="electronic_payment_ref" placeholder="Payment Reference">
                                </div>
                            ...
                            {{-- <tr>
                                        <td width="80">Quantity<input type="text"
                                                class="form-control finalquantity" name="finalquantity" value=""
                                                readonly="readonly"></td>
                                        <td>Amount<input type="text" class="form-control finalamount"
                                                name="finalamount" value="" readonly="readonly"></td>
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-4 col-12">
                                    Total Amount
                                    <input type="text" class="form-control finalgstamount" name="finalgstamount"
                                        value="" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="row mb-5">
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" class="form-control" name="total_without_tax" value=""
                                        id="total_without_tax" readonly="readonly">
                                </div>
                                <div class="col-md-4 col-12">
                                    GST Amount
                                    <input type="text" class="form-control" name="final_igst_amount" value=""
                                        id="gst_amount_of_all" readonly="readonly">
                                </div>
                                <div class="col-md-4 col-12">
                                    Grand Total ( With GST )
                                    <input type="text" class="form-control" name="grand_total_gst" value=""
                                        id="grand_total_gst" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="row mb-5">
                                <div class="col-md-12 col-12">
                                    ...
                                    <input type="text" class="form-control" name="amount_words" value="Nill"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                // $(".table thead th:nth-child(7)").hide();
                // $(".table tbody td:nth-child(7)").hide();

                // $(".access_data table_row th:nth-child(7)").hide();
                ...
                if (supplier_id == '' || company_id == '') {
                    ...
                    data +=
                        '<td><input type="number" name="hsn_code[]"  id="hsn_code' + i +
                        '" class="form-control hsn_code" placeholder="Enter hsn code" min="0" oninput="this.value = Math.abs(this.value)"></td>';

                    data +=
                        '<td><input type="number" name="quantity[]"  id="quantity_' + i +
                        '" data-myval="' + i +
                        '" class="form-control quentity" placeholder="Enter quentity name" min="0" required></td>';

                    data +=
                        '<td><input type="number" name="rate[]"  id="product_rate_' + i +
                        '" data-myval="' + i +
                        '" class="form-control product_rate" placeholder="Enter rate" min="0" required></td>';

                    // new changes by mahesh sir on 29_3_23

                    data +=
                        '<td><input type="float" name="grams[]"  id="grams_' + i +
                        '"  data-myval="' + i +
                        '" class="form-control grams" placeholder="Enter Grams"></td>';

                    data +=
                        '<td><select  name="unit[]" class="form-control unit" id="unit_' +
                        i + '" style="width: 60px" required>';
                    ...
                    data +=
                        '<td><input type="number" name="orignal_amount[]"  id="orignal_amount' + i +
                        '"  data-myval="' + i +
                        '" class="form-control orignal_amount" placeholder="Enter amount" style="width: 80px" readonly></td>';

                    data +=
                        '<td><input type="number" name="discount[]"  id="discount_' + i +
                        '" class="form-control discount" placeholder="disc" min="0" oninput="this.value = Math.abs(this.value)"></td>';


                    data +=
                        '<td><input type="float" name="amount[]"  id="product_amount' + i +
                        '"  data-myval="' + i +
                        '" class="form-control product_amount" placeholder="Enter amount" style="width: 80px"></td>';


                    // data +=
                    //     '<td><select  name="group[]" class="form-control group" id="group_' +
                    //     i + '" style="width: 80px">';
                    // data += '<option value="">GRP</option>';
                    // @foreach ($product_grp as $grp)
                    //     data += '<option value="{{ $grp }}">{{ $grp }}</option>';
                    // @endforeach
                    // data += '</select></td>';
                    ...
                    // data +=
                    // '<td><input type="text" name="kg[]"  id="kg_' + i +
                    // '"  data-myval="' + i +
                    // '" class="form-control kg" placeholder="Enter kg"></td>';
                    // data +=
                    // '<td><input type="text" name="mil[]"  id="mil_' + i +
                    // '"  data-myval="' + i +
                    // '" class="form-control mil" placeholder="Enter mil"></td>';
                    // data +=
                    // '<td><input type="text" name="lit[]"  id="lit_' + i +
                    // '"  data-myval="' + i +
                    // '" class="form-control lit" placeholder="Enter lit"></td>';
                    ...
                    data +=
                        '<td><input type="float" name="gst_amount[]"  id="gst_amount' + i +
                    ...
                    data +=
                        '<td><input type="float" name="total_amount[]"  id="total_amount' + i +
            ...
            $(document).on('change', '.quentity', function() {
                ...
                console.log("#total_amount" + get_id, row_total_gst.toFixed(2));

                // }
                calculateDiscount(get_id);
                calculateFinalAmount();
                amountWords();
                console.log("2#total_amount" + get_id, $("#total_amount" + get_id).val());
            ...
            $(document).on('change', '.product_rate', function() {
                ...
                if (gst_percent == '') {
                    var gst_amount = (product_amount * gst_percent) / 100;
                    var row_total_gst = Number(product_amount) + Number(gst_amount);
                    $("#total_amount" + get_id).val(row_total_gst.toFixed(2));
            ...
            function calculateFinalAmount() {
                ...
                // console.log(Math.round(gst_amount * 100 / 100));
                $('#gst_amount_of_all').val(Math.round(gst_amount * 100 / 100));
                $('#grand_total_gst').val(Math.round(row_total_amount * 100 / 100));

                // console.log($('#grand_total_gst').val());

                var val = Math.round(row_total_amount * 100 / 100).toFixed(2);
            ...
            function calculateDiscount(get_id) {
                ...
                if (quentity != '' && unit == 'Gm') {
                    ...
                    // $('#product_amount' + get_id).val(product_amount);
