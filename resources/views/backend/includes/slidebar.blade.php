...
<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
  <div class="sidebar-brand d-none d-md-flex">
    <h4 class="text-light">BILLING APPLICATION</h4>
  </div>
  <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
    <li class="nav-item"><a class="nav-link" href="{{ route('admin.dashboard') }}">
      ...
      <li class="nav-item"> <a class="nav-link"  href="{{ $suburl }}"> <span class="menu-item" data-i18n="{{ $submenu->submenu_name }}">{{ $submenu->submenu_name }}</span> </a></li>
      ...
      @endphp
            <li class=" nav-item"><a href="{{ $url }}" class="nav-link"><i class="menu-livicon" data-icon="{{ ($menu->menu_icon)?$menu->menu_icon:'notebook' }}"></i><span class="menu-title" data-i18n="{{$menu->menu_name}}">{{$menu->menu_name}}</span></a>
  ...
  <div class="container-fluid d-flex align-items-center">
    ...
    <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
      <a href="{{route('admin.dashboard')}}" >
        <h4 class="nav-logo">Billing Application</h4>
        {{-- <img alt="Logo" src="assets/media/logos/logo-light.svg" class="h-15px h-lg-20px logo-default" /> --}}
        {{-- <img alt="Logo" src="{{ asset('public/assets/media/logos/logo-light.svg') }}" class="h-15px h-lg-20px logo-default" /> --}}
        {{-- <img alt="Logo" src="{{ asset('public/assets/media/logos/logo-default.svg') }}" class="h-15px h-lg-20px logo-default" /> --}}
    ...
    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
      ...
      @endphp
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
              <span class="menu-link py-3" data-i18n="{{$menu->menu_name}}">
          ...
          @endphp
                <div class="menu-item">
                  <a class="menu-link py-3" href="{{ $suburl }}">
                    ...
                    <span class="menu-title" data-i18n="{{ $submenu->submenu_name }}">{{ $submenu->submenu_name }}</span>
                  </a>
                </div>
                @php
                }
