      ...
      <div class="card-body">
        ...
        {{-- <p class="card-description">Create Vehicle </p> --}}
                 @include('backend.includes.errors') 
                  {{ Form::open(array('url' => 'admin/vehicle/store')) }}
                  @csrf
                    <div class="form-body">
                      <div class="row">
                        <div class="col-md-6 col-12">
                          <div class="form-label-group mb-5">
                            ...
                            {{ Form::select('vehicle_make_id', $make , null, ['class' => 'form-select', 'placeholder' => 'Enter Vehicle Name', 'required' => true]) }}
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                          <div class="form-label-group mb-5">
                            ...
                            {{ Form::select('vehicle_model_id', $model , null,['class' => 'form-select', 'placeholder' => 'Enter Model', 'required' => true]) }}
                          </div>
                        </div>
    {{-- 
