                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div id="payment_electronic_ref">
                                        <input type="text" class="electronic_payment_ref" name="electronic_payment_ref"
                                                    ...
                                                    <tr id="row{{ $loop->iteration - 1 }}">
                                                        ...
                                                        <th scope="col"><select name="cgst_percent[]"
                                                                ...
                                                                @foreach ($gst_percent as $gst)
                                                                    @if ($product_detail->cgst_percent + $product_detail->sgst_percent == $gst)
                                                        ...
                                                        <th scope="col"><input type="text" name="gst_amount[]"
                                                                ...
                                                                value="{{ $product_detail->cgst + $product_detail->sgst }}"
