                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::Select('supplier_id', $supplier, $data->supplier_id, ['class' => 'form-select supplier_select', 'placeholder' => 'Select Supplier', 'id' => 'supplier_id', 'required' => true]) }}
                                                    ...
                                                    @foreach ($data->Product_details as $product_detail)
                                                        <tr id="row{{ $row_id = $loop->iteration - 1 }}">
                                                            ...
                                                            <th scope="col"><input type="number"
                                                                    ...
                                                                    placeholder="Enter amount" style="width: 80px"></th>

                                                            <th scope="col"><input type="number" name="discount[]"
                                                                    id="discount_{{ $loop->iteration - 1 }}"
                                                                    value="{{ $product_detail->discount }}"
                                                                    class="form-control discount" placeholder="disc" style="width: 80px"></th>
                                                            ...
                                                            <th>
                                                                <li id="{{ $loop->iteration - 1 }}"
                                                                    class="fa-sharp fa-solid fa-trash remove_row"></li>
                                                            </th>
                                                        </tr>
                                                    @endforeach
                                                @endif
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                if (supplier_id == '' || company_id == '') {
                    ...
                    data +=
                        ...
                        '" class="form-control discount" placeholder="disc" style="width: 80px"></td>';
