                            ...
                            right: 50px;">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div id="payment_m">
                                            <input type="number" class="cheque_no" name="cheque_no"
        ...
        $(document).ready(function() {
            ...
            jQuery('#add_btn').on('click', function() {
                ...
                if (supplier_id == '' || company_id == '') {
                    ...
                    data +=
                        '<td><input type="mumber" name="gst_amount[]"  id="gst_amount' + i +
                    ...
                    data +=
                        '<td><input type="number" name="total_amount[]"  id="total_amount' + i +
