...
<div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
    <div class="col-lg-6 col-md-6 col-sm-12">
        <h4 class="text-white fw-bolder fs-2qx me-5">Purchase</h4>
    </div>       
                        ...
                        <div id="table-wraper">
                            <table class="table-bordered tbl-datatable" cellpadding="5" width="98%" style="">
                                ...
                                @if (isset($purchase_bill->product_details) && count($purchase_bill->product_details) > 0)
                                    @foreach ($purchase_bill->product_details as $product_detail)
                                        ...
                                        <tr class="min_height">
                                            ...
                                            <td width="250">{{ $product_detail->product_name }}</td>
                                            <td align="right">{{ $product_detail->hsn_code }}</td>
                                            <td align="right">{{ $product_detail->quantity }}</td>
                                ...
                                <tr>
                                    ...
                                    <td align="right">{{ $product_detail->total_quantity }}</td>
                                    <td></td>
