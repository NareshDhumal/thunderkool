    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="page-header">
                <h3 class="page-title">Edit Purchase bill</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::text('supplier_state', null, ['class' => 'form-control supplier_state', 'placeholder' => '', 'id' => 'supplier_state']) }}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::Select('company_id',$comapany ,$data->company_id,['class' => 'form-control', 'required' => true]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <input value="" type="text" id="purchase_bill_no"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <input value="<?php echo date('d-m-Y',strtotime($data->dated));?>" type="date" id="date_of_issue"
