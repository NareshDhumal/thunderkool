                    ...
                    <div class="form-body">
                        ...
                        <div class="row mt-4">
                            ...
                            <div style="padding:0px 50px;display:flex;justify-content:space-between">
                                ...
                                <div>
                                    <input class="form-check-input" type="checkbox" name="invoice_cum_challan" {{$invoice->invoice_cum_challan == 1 ? 'checked' : '' }} value="1" id="invoice_cum_challan">
                        ...
                        <div class="row" id="vehicle_container" style="display:none">
                            <div style="text-align:left" class="col-md-6 col-12">
                                ...
                                <div class="row g-2 mt-2">
                                    <div class="col-6">
                                        {{Form::select('vehicle_make_id',
                                        [],null,['class'=>'form-select','id'=>'vehicle_make_id','placeholder'=>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="thead_content" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}">
                                        ...
                                        <tbody id="tbody_product">
                                            ...
                                            {{-- @php $key++ @endphp --}}
                                            <tr id="row_{{$key}}">
                                                <input type="hidden" class="product" id="product" value="{{$key}}">
                                                <td>
                                                    <select style="min-width:150px !important;" class="form-select" name="product_description_{{$key}}" id="product_description_input_{{$key}}">
                                                        @foreach($products as $p)
                                                        <option {{$product->product_id == $p->product_id ? 'selected' :
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="cwg_thead_content" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}">
                                        ...
                                        <tbody id="cwg_tbody_product">
                                            ...
                                            <tr id="cwg_row_{{$key}}">
                                                <input type="hidden" class="product" id="product" value="{{$key}}">
                                                <input type="hidden" name="previous_quantity_{{$key}}" id="previous_quantity_{{$key}}" value="{{ $product->quantity }}">
                                                <td>
                                                    <select style="min-width:150px !important;" class="form-select" name="product_description_{{$key}}" id="cwg_product_description_input_{{$key}}" onChange="getProduct({{$key}});">
                                                        @foreach($products as $p)
                                                        @php
                                                ...
                                                <td>
                                                    ...
                                                    <select style="min-width:80px !important;" class="form-select unit_select_input" name="p_unit_{{$key}}" id="cwg_p_unit_{{$key}}" onChange="calculateUnit({{$key}});">
                                                        @foreach($units as $unit)
                                                        <option {{$unit->P_unit_id == $product->p_unit ? 'selected' : ''
                                                            }} value="{{$unit->P_unit_id}}">{{$unit->unit}}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            ...
                                            <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                ...
                                                <td colspan="2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="free_of_charge" value="1" {{$invoice->free_of_charge
                                                        == 1 ? 'checked' : ''}} id="free_of_charge">
