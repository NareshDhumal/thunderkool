							...
							<div class="d-flex align-items-center flex-wrap py-2">
								...
								<div id="kt_header_search" class="d-flex align-items-center w-200px w-lg-250px my-2 me-4 me-lg-6" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
									...
									<form data-kt-search-element="form" class="search w-100 position-relative" autocomplete="off">
										...
										<span class="svg-icon svg-icon-2 svg-icon-lg-1 search-icon svg-icon-white position-absolute top-50 translate-middle-y ms-5">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<!--end::Icon-->
										<!--begin::Input-->
										<input type="text" class="form-control bg-secondary ps-15" name="search" value="" placeholder="Search..." data-kt-search-element="input" />
										<!--end::Input-->
										<!--begin::Spinner-->
								...
								<!--end::Action-->
								<!--begin::Button-->
								<a href="#" class="btn btn-success my-2" tooltip="New App" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Know More</a>
								<!--end::Button-->
							</div>
							<!--end::Actions-->
						</div>
													...
													<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
														...
														<div class="card-body d-flex flex-column justify-content-between p-0">
															...
															<div class="d-flex flex-column px-9 pt-5">
																...
																<!--end::Number-->
																<!--begin::Description-->
																<span class="text-success fw-boldest fs-2hx">Weekly New Followers</span>
																<!--end::Description-->
															</div>
															<!--end::Hidden-->
															<!--begin::Chart-->
											...
											<div class="card card-xl-stretch mb-5 mb-xl-8">
												...
												<div class="card-body pt-5">
													...
													<div class="d-flex align-items-sm-center">
														...
														<div class="symbol symbol-circle symbol-50px me-5">
															<span class="symbol-label">
																<img src="{{ asset('public/assets/media/svg/brand-logos/fox-hub.svg')}}" class="h-50 align-self-center" alt="" />
															</span>
														</div>
														<!--end::Symbol-->
														<!--begin::Section-->
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="{{ asset('public/assets/media/avatars/150-11.jpg') }}" alt="img" />
