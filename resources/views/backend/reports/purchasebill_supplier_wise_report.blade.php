...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">purchasebill Supplier Wise Reports</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card p-5">
                            {{-- @endcan --}}
                            {{-- new code --}}
                            {{ Form::open(['url' => 'admin/purchasebill/supplierreport', 'method' => 'get']) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-label-group">
                                                {{ Form::label('supplier_id', 'Search By Supplier *') }}
                                ...
                                <div class="table-responsive">
                                    <table class="table zero-configuration" id="tbl-datatable">
                                        ...
                                        <tbody>
                                            ...
                                            @if (isset($purcase_bill) && count($purcase_bill) > 0)
                                                {{-- {{dd($purcase_bill->toArray())}} --}}
                                                @php $srno = 1; @endphp
                                                @foreach ($purcase_bill as $data)
                                                    @if (isset($data->Product_details) && count($data->Product_details) > 0)
