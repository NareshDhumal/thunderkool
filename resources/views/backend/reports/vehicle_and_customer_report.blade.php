...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Invoice Search By Vehicle Number And Customers</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card p-5">
                            {{-- @endcan --}}
                            {{-- new code --}}
                            {{ Form::open(['url' => 'admin/invoice/vehicle/customerreport', 'method' => 'get']) }}
                            <div class="row align-items-end mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-label-group">
                                                ...
                                                {{ Form::select('vehicle_id', $vehicle, Request::get('vehicle_id'), ['class' => 'form-select', 'placeholder' => 'Select Vehicle', 'id' => 'vehicle_id']) }}
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-label-group">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a class="btn btn-primary mb-1" href="{{ url('admin/invoice/vehicle/customerreport') }}">Reset</a>
                                            ...
                                            @if (isset($invoice) && count($invoice) > 0)
                                                ...
                                                @foreach ($invoice as $data)
                                                    ...
                                                    @php
                                                        ...
                                                        // $product_invoice = ProductInvoice::where('invoice_id',$data->invoice_id)->get();
                                                        // dd($product_invoice->toArray());
                                                    @endphp
                                                    <tr>
                                                        <td>{{ $srno }}</td>
                                                        ...
                                                        <td>{{ $data->total_gst_amount ? $data->total_gst_amount : 'N/A' }}
                                                        </td>
    ...
    <script>
        ...
        function exportexcel() {
            $("#tbl-datatable").remove(".noexcel").table2excel({
                name: "Table2Excel",
                filename: "Vehicle And Customer report",
                fileext: ".xls",
                exclude_links: true,
