    ...
    <div class="content">
        ...
        <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <h4 class="text-white fw-bolder fs-2qx me-5">Edit Invoice</h4>
            </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row" id="vehicle_container" style="display:none">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="row" id="vehicle_details">
                                        <div class="col-9">
                                            <textarea class="form-control" style="height:100px" id="vehicle_details_input" name="vehicle">{{ $invoice->vehicle }}</textarea>
                                        </div>
                                        <div class="col-3">
                                                        ...
                                                        <tr id="cwg_row_{{ $key }}">
                                                            ...
                                                            <td>
                                                                <input style="min-width:80px !important;"
                                                                    ...
                                                                    onChange="getorignalamount({{ $key }})" readonly>
                                                            </td>
                                                            <td>
                                                                <input style="min-width:80px !important;"
                                                                    name="discount_{{ $key }}"
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-start mt-3">
                                {{ Form::submit('Edit', ['class' => 'btn btn-primary mr-1 me-2']) }}
