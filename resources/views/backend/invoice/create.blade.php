...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.invoice.index') }}" class="btn btn-secondary my-2" data-bs-toggle="tooltip"
...
@section('scripts')
    <script>
                        ...
                        if (product != null) {
                            Object.entries(product).forEach(entry => {
                                ...
                                if (service_id == '1') {
                                    ...
                                    $(`#cwg_p_unit_${pc}`).prop('required', false);
                                    //change on 5 5 23
        ...
        function putAmount(pc, amount) {
            ...
            //code on 6_6_23
            // if (company_with_gst == '1' || service_id == 1) {
            //     var discounted_amount = $(`#cwg_amount_${pc}`).val();
            //     console.log(discounted_amount);
            //     $(`#cwg_total_amount_${pc}`).val();
            //     $(`#cwg_cgst_amount_${pc}`).val('0');
            //     $(`#cwg_sgst_amount_${pc}`).val('0');
            //     $(`#cwg_igst_amount_${pc}`).val('0');
