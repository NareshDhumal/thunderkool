...
@php
    ...
    $invoice = Invoice::with('productsInvoice')
        ->whereIn('invoice_id', $myArray)
        ->get();
...
@section('content')
    ...
    <div class="container-fluid my-md-4 flex-grow-1">
        <div class="card shadow border-0">
            ...
            <div class="card-body">
                <main id="table-print" class="docs-main order-1">
                    ...
                    @if ($copies == '1')
                        ...
                        @foreach ($invoice as $item)
                            @php
                                $company_short_name = Company::where('company_id', $item->company_id)->first();
                            @endphp
                            ...
                            <div class="table-wraper">
                                <table class="table-bordered" width="100%" style="width:100%">
                                    ...
                                    @php
                                        if ($item->gst_flag == 1) {
                                            $item_title = 'TAX-INVOICE';
                                        } else {
                                            $item_title = 'INVOICE';
                                        }
                                        // Fetching Company
                                        $company = Company::where('company_id', $item->company_id)->first();
                                        // if($company) {
                                        ...
                                        // }
                                        // Fetching Customer
                                        $customer = Customers::where('customer_id', $item->customer_id)->first();
                                        ...
                                        // if ($item->invoice_cum_challan == '1') {
                                        //     $item_title = 'INVOICE CUM CHALLAN';
                                        // }
                                        // Fetching Vehicle make
                                        $vehicle_make = VehicleMake::where('vehicle_make_id', $item->vehicle_make_id)->first();
                                        // if($vehicle_make) {
                                        $vehicle_make_name = $vehicle_make->vehicle_make_name ?? '';
                                        // }
                                        // Fetching Vehicle Model
                                        $vehicle_model = VehicleModel::where('vehicle_model_id', $item->vehicle_model_id)->first();
                                        // if($vehicle_model) {
                                        $vehicle_model_name = $vehicle_model->vehicle_model_name ?? '';
                                        // }
                                        // Fetching Vehicle
                                        $vehicle = Vehicle::where('customer_id', $item->customer_id)
                                            ->where('vehicle_make_id', $item->vehicle_make_id)
                                            ->where('vehicle_model_id', $item->vehicle_model_id)
                                            ->first();
                                        // if($vehicle) {
                                    ...
                                    <tr style="border: 0;">
                                        <th colspan="16" style="font-size:15px;text-align: center; border: 0;">
                                            <h3>{{ $item_title }}</h3>
                                        </th>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            Invoice No:<br>
                                            <b>{{ $company_short_name->company_short_name }}{{ $item->financial_year . '' . $item->invoice_no }}</b>
                                        </td>
                                        <td colspan="4">
                                            Date:<br>
                                            <b>{{ date('d-m-Y', strtotime($item->date_of_issue)) }}</b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                    ...
                                    @if ($item->gst_flag == 1)
                                        ...
                                        @endphp
                                        @forelse($item->productsInvoice as $key => $data)
                                            @php
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-weight: bold;" colspan="2">{{ $product_total_amt ?? '-' }}
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        <td colspan="8" style="width: 50%;">
                                            ...
                                            <strong>{{ $item->amt_in_words }}</strong>
                                        </td>
                                    ...
                                    @php
                                        ...
                                        if ($item->payment_method == 'Pending') {
                                            ...
                                            $payment_method = 'Cheque, Bank Name :' . $item->bank_name . ', Cheque No :' . $item->cheque_no;
                                        } elseif ($item->payment_method == 'Electronic Transaction') {
                                            $payment_method = 'Electronic Transaction, Electronic Payment Ref :' . $item->e_transaction_ref;
                                    ...
                                    <tr style="border-top: 0; border-right: 1px solid #6c757d;">
                                        ...
                                        <td colspan="8" style="width: 50%; ">
                                            ...
                                            <ul
                                                style="display: none; justify-content: space-between; list-style-type: none;">
                                                <li>Received</li>
                                                <li>₹10.00</li>
                                            </ul>
                                        </td>
                                    ...
                                    @if ($item->gst_flag == 1)
                                        @if ($customer->state == '21')
                                            ...
                                            <tr>
                                                <td style="font-weight: bold;" colspan="3" rowspan="2">HSN/ SAC
                                                </td>
                                                <td style="font-weight: bold;" colspan="2" rowspan="2">Taxable
                                                    Amount
                                                </td>
                                                <td style="font-weight: bold;" colspan="4">CGST</td>
                                                <td style="font-weight: bold;" colspan="4">SGST</td>
                                                <td style="font-weight: bold;" colspan="3" rowspan="2">Total Tax
                                                    Amount
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            @foreach ($item->productsInvoice as $key => $data)
                                                <tr>
                                        ...
                                        @else
                                            ...
                                            <tr>
                                                <td style="font-weight: bold;" colspan="4" rowspan="2">HSN/ SAC
                                                </td>
                                                <td style="font-weight: bold;" colspan="4" rowspan="2">Taxable
                                                    Amount
                                                </td>
                                                <td style="font-weight: bold;" colspan="4">IGST</td>
                                                <td style="font-weight: bold;" colspan="4" rowspan="2">Total Tax
                                                    Amount
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-weight: bold;" colspan="8">{{ $item->total_amount ?? '' }}
                                            </td>
                                        </tr>
                                        </tr>
                                    @endif
                        ...
                        @foreach ($invoice as $item)
                            ...
                            <div class="table-wraper">
                                <table class="table-bordered" width="100%" style="width:100%">
                                    ...
                                    <tr style="border: 0;">
                                        <th colspan="9" style="font-size:15px;text-align: right; border: 0;">
                                    ...
                                    <tr style="border-bottom: 0; ">
                                        <td colspan="8"
                                            style="vertical-align: text-top; width: 50%; border-bottom: 0; ">
                                            Ship To<br>
                                            Self pick up
                                        </td>
                                    </tr>
