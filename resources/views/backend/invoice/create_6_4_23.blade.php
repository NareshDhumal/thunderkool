...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Create Invoices</h4>
        </div>
        {{-- @can('Create Admin Users') --}}

        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.invoice.create') }}" class="btn btn-secondary my-2" data-bs-toggle="tooltip"
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{ Form::open(['url' => 'admin/invoice/store', 'id' => 'invoice_form']) }}
                        @php
                            if (date('m') > 4) {
                        ...
                        <div class="form-body mb-5">
                            ...
                            <div class="row mt-4 mb-5">
                                ...
                                <div style="min-height:100px" id="invoice_no">
                                    <input type="text" id="invoice_no" name="invoice_no" value="{{$last_invoice_id}}"
                                ...
                                <div style="text-align:left" class="col-md-6 col-12">
                                    ...
                                    <div class="row g-5 mt-2">
                                        <div class="col-6">
                                            ...
                                            {{ Form::select('vehicle_make_id', ['' => 'Select a VehicleMake'], null, ['class' => 'form-select', 'id' => 'vehicle_make_id']) }}
                                        </div>
                                        <div class="col-6">
                                            <p style="font-weight:600">Vehicle Model</p>

                                            {{ Form::select('vehicle_model_id', ['' => 'Select a VehicleModel'], null, ['class' => 'form-select', 'id' => 'vehicle_model_id']) }}
                                        </div>
                                    </div>
                                </div>
                                {{-- <div style="text-align:left" class="col-md-6 col-12">
                                                ...
                                                <tr style="background:rgba(70,70,70,0.1)">
                                                    ...
                                                    <td>
                                                        <input style="min-width:60px !important;"
                                                            ...
                                                            class="form-control cwg_total_amount_all_without_gst" readonly>
                                                    </td>
                                                    <td></td>
            ...
            $('#add_product').click(function() {
                ...
                if (company_with_gst == 0) {
                    ...
                    <tr id="row_${product_counter}">
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="quantity_${product_counter}" id="cwg_quantity_${product_counter}" class="form-control cwg_quantity" onChange="getCWGAmount(${product_counter});" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">    
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="hidden" style="min-width:80px !important;" name="cwg_rate_${product_counter}" id="cwg_rate_${product_counter}" class="form-control cwg_rate" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">       
                        </td>   
                ...
                `);
                    ...
                    <tr id="cwg_row_${product_counter}">
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="rate_${product_counter}" id="rate_${product_counter}" class="form-control cwg_rate" onChange="getrate(${product_counter})" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                        ...
                        <td hidden>
                            <input style="min-width:80px !important;" name="product_stock_${product_counter}" id="product_stock_${product_counter}" class="form-control product_stock">    
                        </td>   
                        ...
                        if (product != null) {
                            Object.entries(product).forEach(entry => {
                                ...
                                if (value.product_unit == 'Nos') {
                                    ...
                                    $(`#cwg_p_unit_${pc} option[value="1"]`).prop('disabled',
                                        false);
            ...
            if (company_with_gst == '1') {
                if (amount != '' && amount != 0) {
                    ...
                    if (customer_state == '21') {
                        ...
                        // console.log(cgst_percent);
                        // console.log(sgst_percent);


                        let cgst_amount = parseFloat((amount * cgst_percent) / 100);
                        let sgst_amount = parseFloat((amount * sgst_percent) / 100);
                        ...
                        // console.log($(`#cwg_total_amount_${pc}`).val(parseFloat(total_amount).toFixed(2)));
