    ...
    {{-- <div id="kt_toolbar_container" class="d-flex flex-stack flex-wrap"> --}}
      {{-- <div class=""> --}}
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Invoice View</h4>
        </div>       
                {{-- @can('Create Admin Users') --}}
            {{-- <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
                <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary my-2 me-4" id="export_excel"><i class="bx bx-plus"></i>Back</a>
        ...
        {{-- <form method="post"> --}}
            <div id="table-wraper">
                <table class="table-bordered tbl-datatable" cellpadding="5" width="100%" style="">
                    ...
                    // }
                    // Fetching Vehicle
                    $vehicle = Vehicle::where('customer_id', $invoice->customer_id)->where('vehicle_make_id',
                    $invoice->vehicle_make_id)->where('vehicle_model_id', $invoice->vehicle_model_id)->first();
                    // if($vehicle) {
                    ...
                    <tr>
                        <td colspan="3" align="center"><img src="{{asset('/storage/app').$company->company_logo}}"
                                width="200"></td>
                    ...
                    <tr>
                        <td colspan="14" class="bold">Invoice No. TK GST 00 {{ $invoice->invoice_no.'
                            '.$invoice->financial_year }}</td>
                    </tr>
                    <tr>
                        <td colspan="14" class="bold">Dated: {{ date("d-m-Y", strtotime($invoice->date_of_issue)) }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="6" rowspan="2" style="text-transform:uppercase;">
                            ...
                            GST NO : {{ $c_gst_no }}</td>
                        <td colspan="4" style="text-transform:uppercase;">Vehicle No : {{ $invoice->vehicle_number
                            }}</span></td>
                        <td colspan="4" style="text-transform:uppercase;">Serial No : {{ $serial_no }}</td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-transform:uppercase;">Model : {{ $vehicle_model_name }}</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="4" rowspan="2" align="center"><img
