                ...
                <table class="table-bordered tbl-datatable" cellpadding="5" width="100%" style="">
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <img src="{{ asset('/storage/app') . $company->company_logo }}"
                                width="200"></td>
                        <td colspan="8" class="company_nm" align="center">
                    ...
                    <tr>
                        <td colspan="14" class="bold">Invoice No. {{ $company_short_name->company_short_name }} GST 00
                            {{ $invoice->invoice_no .
                                '
                                                                                    ' .
