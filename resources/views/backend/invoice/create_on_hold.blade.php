                                        ...
                                        <table class="table table-bordered" id="cwg_thead_content" style="display:none">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th id="hsn_code" colspan="2">SGST</th>
                                                    <th id="hsn_code" colspan="2">IGST</th>
                                                    <th id="hsn_code" colspan="2">CGST</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th id="hsn_code">Percent</th>
                                                    <th id="hsn_code">Amount</th>
                                                    <th id="hsn_code">Amount</th>
                                                    <th id="hsn_code">Percent</th>
                                                    <th id="hsn_code">Amount</th>
                                                    <th id="hsn_code">Percent</th>
            ...
            $('#add_product').click(function() {
               ...
               if(company_with_gst == 1 || company_with_gst == 0) {
                    ...
                    <tr id="cwg_row_${product_counter}">
                        ...
                        alert(company_with_gst);
                    if (company_with_gst == '1') {
                        
                        table_data += `WWWWW<td id="hsn_code">
