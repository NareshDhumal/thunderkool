                    ...
                    <div id="table-wraper">
                        <table class="table-bordered tbl-datatable" cellpadding="5" width="100%" style="width:100%">
                            ...
                            <tr class="">
                                ...
                                <td class="bold" rowspan="2" colspan="1">HSN/SAC Code</td>
                                ...
                                <td class="bold" rowspan="2" colspan="1">Discounted Amt</td>
                        ...
                        @else
                            <tr class="">
                                ...
                                <td class="bold" colspan="3">Product Description</td>
                                <td class="bold" colspan="2">HSN/SAC Code</td>
                            ...
                            <tr>
                                <td colspan="10" align="right" class="bold" style="text-transform:uppercase;">
                                    Total
                                </td>
                                <td colspan="3">
                                    {{ $invoice->base_amount ?? '-' }}
