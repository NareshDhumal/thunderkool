                        ...
                        <div class="row" style="display:none" id="customer">
                            ...
                            <div style="text-align:left" class="col-md-6 col-12">
                                ...
                                <div style="min-height:100px" id="customer_details">
                                    <textarea class="form-control" id="customer_details_input" name="vehicle"
                                        readonly></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="vehicle_container" style="display:none">
                            ...
                            <div style="text-align:left" class="col-md-6 col-12">
                                ...
                                <div style="min-height:100px" id="vehicle_details">
                                    <textarea class="form-control" id="vehicle_details_input"
                                        name="vehicle">{{ $invoice->vehicle }}</textarea>
                                    <input placeholder="KM" type="number" name="km" value="{{$invoice->km}}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered" id="thead_content"
                                        ...
                                        <tbody id="tbody_product">
                                            ...
                                            <tr id="row_{{$key}}">
                                                ...
                                                <td>
                                                    <select style="min-width:150px !important;" class="form-select"
                                                        name="product_description_{{$key}}"
                                                        id="product_description_input_{{$key}}">
                                                ...
                                                <td>
                                                    <input class="product_amount form-control" id="product_amount"
                                                        data-id="{{$key}}" type="text" onchange="getAmount()"
                                                        name="product_amount_{{$key}}"
                                                        value="{{ $product->product_amount }}">

                                                    <input type="hidden" name="product_invoice_id_{{$key}}"
                                    ...
                                    <table class="table table-bordered"
                                        ...
                                        <tbody>
                                            <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                ...
                                                <td colspan="2">Total : <input name="total_amount" class="form-control"
                                                        type="text" id="product_total_amount"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="cwg_thead_content"
                                        ...
                                        <tbody id="cwg_tbody_product">
                                            ...
                                            <tr id="cwg_row_{{$key}}">
                                                <input type="hidden" class="product" id="product" value="{{$key}}">
                                                <input type="hidden" name="previous_quantity_{{$key}}"
                                                    id="previous_quantity_{{$key}}" value="{{ $product->quantity }}">
                                                <td>
                                                    <select style="min-width:150px !important;" class="form-select"
                                                        name="product_description_{{$key}}"
                                                ...
                                                <td>
                                                    <input style="min-width:80px !important;" name="hsn_code_{{$key}}"
                                                        id="cwg_hsn_code_{{$key}}" class="form-control cwg_hsn_code"
                                                        value="{{ $product->hsn_code }}">
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="quantity_{{$key}}"
                                                        id="cwg_quantity_{{$key}}" class="form-control cwg_quantity"
                                                ...
                                                <td>
                                                    ...
                                                    <select style="min-width:80px !important;"
                                                        class="form-select unit_select_input" name="p_unit_{{$key}}"
                                                        id="cwg_p_unit_{{$key}}" onChange="calculateUnit({{$key}});">
                                                ...
                                                <td>
                                                    <input style="min-width:80px !important;" name="rate_{{$key}}"
                                                        id="cwg_rate_{{$key}}" class="form-control cwg_rate"
                                                        value="{{ $product->rate }}">
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="amount_{{$key}}"
                                                        value="{{ $product->product_amount }}" id="cwg_amount_{{$key}}"
                                                ...
                                                <td>
                                                    <input style="min-width:80px !important;"
                                                        name="cgst_amount_{{$key}}" value="{{ $product->cgst_amount }}"
                                                ...
                                                <td>
                                                    <input style="min-width:80px !important;"
                                                        name="sgst_amount_{{$key}}" value="{{ $product->sgst_amount }}"
                                                ...
                                                <td>
                                                    <input style="min-width:80px !important;"
                                                        name="igst_amount_{{$key}}" value="{{ $product->igst_amount }}"
                                                        id="cwg_igst_amount_{{$key}}"
                                                        class="form-control cwg_igst_amount" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="discount_{{$key}}"
                                                        id="cwg_discount_{{$key}}" value="{{ $product->discount }}"
                                            ...
                                            <tr style="background:rgba(70,70,70,0.1)">
                                                ...
                                                <td>
                                                    <input style="min-width:60px !important;" name="total_quantity"
                                                        id="cwg_total_quantity" class="form-control"
                                                        value="{{ $total_quantity }}" readonly>
                                                </td>
                                                <td></td>
                                                <td>
                                                ...
                                                <td>
                                                    <input style="min-width:60px !important;"
                                                        ...
                                                        class="form-control" value="{{ $invoice->total_amount }}"
                                                        readonly>
                                                </td>
                                                <td></td>
                                            </tr>
                                        ...
                                        <tbody>
                                            <tr id="cwg_total" style="background:rgba(70,70,70,0.1)">
                                                ...
                                                <td>
                                                    ...
                                                    <input name="cwg_total_amount" class="form-control" type="text"
                                                        id="cwg_total_amount_all_gst_footer"
                                            ...
                                            <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                <td id="payment_method_cell" colspan="4">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="form-check me-4">
                                                            {{ Form::radio('payment_method',
                                                            'Pending',false,['id'=>'pending','class'=>'form-check-input'])
                                                            }}
                                                ...
                                                <td colspan="2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="free_of_charge" value="1" {{$invoice->free_of_charge
        ...
        if (company_with_gst == 0) {
            ...
            $('#cwg_tbody_product').append(`
                    <tr id="cwg_row_${product_counter}">
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="rate_${product_counter}" id="cwg_rate_${product_counter}" class="form-control cwg_rate">    
                        </td>   
                        <td>
