      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="text-end">
              <a href="{{ route('admin.adminusers.create') }}" class="btn btn-inverse-primary btn-fw"><i class="fa fa-plus"></i> Add </a>
              <a href="{{ route('admin.adminusers') }}" class="btn btn-inverse-danger btn-fw"><i class="fa fa-arrow-left"></i><span class="align-middle ml-25">Back</span></a>
            </div>
            {{-- @endcan --}}
