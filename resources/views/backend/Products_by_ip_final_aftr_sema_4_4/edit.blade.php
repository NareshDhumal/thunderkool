...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.products') }}" class="btn btn-secondary my-2"><i class="bx bx-plus"></i>Back</a>
        </div>
    </div>
    <!--end::Toolbar-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::select('service_id', ['0' => 'Select Service', '1' => 'Service', '2' => 'Product'], null, ['class' => 'form-select', 'id' => 'service', 'required' => true]) }}
                                            </div>
                                        </div>
                            ...
                            {{ Form::text('product_code', null, ['class' => 'form-control', 'placeholder' => 'Enter Last Name', 'required' => true]) }}
                                        ...
                                        <div class="col-md-6 col-12 service_hide">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::number('product_rate', null, ['class' => 'form-control', 'placeholder' => 'Enter Rate','min'=> 0]) }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12 service_hide">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::number('product_stock', null, ['class' => 'form-control', 'placeholder' => 'Enter stock','min'=> 0]) }}
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-6 col-12 service_hide">
                          <div class="form-label-group mb-5">
                            ...
                            {{ Form::text('product_party', null, ['class' => 'form-control', 'placeholder' => 'Enter Confirm Password']) }}
                                        ...
                                        <div class="col-md-6 col-12 service_hide">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::number('hsn_code', null, ['class' => 'form-control', 'placeholder' => 'Enter hsn Code','min'=> 0]) }}
                                            </div>
                                        </div>
                            ...
                            {{ Form::text('tax_percent', null, ['class' => 'form-control', 'placeholder' => 'Enter Confirm Password']) }}
                                        ...
                                        <div class="col-md-6 col-12 service_hide">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::number('product_part_no', null, ['class' => 'form-control', 'placeholder' => 'Enter Part No','min'=> 0]) }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12 service_hide">
                                            <div class="form-label-group mb-5">
                                                ...
                                                {{ Form::number('product_part_no_custom', null, ['class' => 'form-control', 'placeholder' => 'Enter Custom Part No','min'=> 0]) }}
                                            </div>
                                        </div>
