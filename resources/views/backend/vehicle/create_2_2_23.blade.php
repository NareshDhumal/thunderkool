                    ...
                    <div class="row">
                      <div class="col-md-6 col-12">
                        <div class="form-label-group">
                          ...
                          {{ Form::select('vehicle_make_id', $make , ['class' => 'form-control', 'placeholder' => 'Enter Vehicle Name', 'required' => true]) }}
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-12">
                        <div class="form-label-group">
                          ...
                          {{ Form::select('vehicle_model_id', $model , ['class' => 'form-control', 'placeholder' => 'Enter Model', 'required' => true]) }}
                        </div>
                      </div>
{{-- 
