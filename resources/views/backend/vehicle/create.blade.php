...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.vehicle', $id) }}" class="btn btn-secondary my-2" title="Back"
    ...
    <section class="db-section admin-form">
        ...
        <a href="{{ route('admin.vehicle') }}" class="btn btn-inverse-danger btn-fw"><i class="bx bx-arrow-back"></i><span class="align-middle ml-25">Back</span></a>
          ...
          {{ Form::text('customer_mobile', $customer_data->mobile_no , null, ['class' => 'form-control', 'required' => true]) }} --}}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-groupmb-5">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group mb-5">
                                            ...
                                            {{ Form::select('vehicle_model_id', [0 => 'select'], null, ['class' => 'form-control', 'placeholder' => 'Select Model', 'id' => 'vehicle_model', 'required' => true]) }}
                                        </div>
                                    </div>
