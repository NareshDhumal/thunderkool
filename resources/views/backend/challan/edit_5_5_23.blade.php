...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Edit Challan</h4>
        </div>
        {{-- @can('Create Admin Users') --}}
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.challan.index') }}" class="btn btn-secondary my-2" data-bs-toggle="tooltip"
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card ">
                    ...
                    right: 50px;">
                        <a href="{{ route('admin.challan.index') }}" class="btn btn-inverse-primary float-right">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                {{-- <h4 class="card-title">Edit Challan</h4> --}}
                            </div>
                            {{-- {{dd($challan)}} --}}
                            <div class="col-md-6 col-12">
                                <select id="company_select" class="form-select" name="company_id_select" required>
                                    ...
                                    @foreach ($companies as $key => $company)
                                        <option {{ $challan->company_id == $key ? 'selected' : '' }}
                                            value="{{ $key }}">
                                            {{ $company }}
                                        </option>
                                    @endforeach
                        ...
                        {{ Form::model($challan, ['url' => 'admin/challan/update', 'id' => 'invoice_form']) }}
                        @csrf
                        {{-- <div class="row">
                        <div class="col-6">
                        ...
                        <input type="hidden" id="company_id" value="{{ $challan->company_id }}" name="company_id"
                        ...
                        <div class="form-body mb-5">
                            ...
                            <div class="row mt-4 mb-5">
                                ...
                                <div class="mb-5">
                                    ...
                                    {{-- <div>
                                        <input class="form-check-input" type="checkbox" name="invoice_cum_challan"
                                            {{ $challan->invoice_cum_challan == 1 ? 'checked' : '' }} value="1"
                                ...
                                <div style="text-align:left" class="col-md-2 col-12">
                                    <p style="font-weight:600">Challan No.</p>
                                    <div style="min-height:100px" id="invoice_no">
                                        <input type="text" id="invoice_no" name="invoice_no"
                                            value="{{ $challan->challan_no }}" class="form-control disabled" readonly>
                                    </div>
                                </div>
                                <div style="text-align:left" class="col-md-3 col-12">
                                    ...
                                    <div style="min-height:100px" id="date_of_issue">
                                        <input value="{{ $challan->date_of_issue }}" type="date" id="date_of_issue_input"
                                            name="date_of_issue" class="form-control">
                                        {{-- <input type="date" /> --}}
                                    </div>
                                </div>

                                <div class="col-md-7" style="display:none" id="customer">
                                    <div class="row">
                                        <div style="text-align:left" class="col-md-3 col-12">
                                        ...
                                        <div style="text-align:left" class="col-md-9 col-12">
                            ...
                            <div class="row" id="vehicle_container" style="display:none">
                                <div style="text-align:left" class="col-md-6 col-12">
                                    <div class="d-flex align-items-center">
                                        <label class="d-flex align-items-center"><input type="checkbox" id="manual_invoice"
                                                {{ $challan->manual_invoice == '1' ? 'checked' : '' }} name="manual_invoice"
                                                value="1" class="me-2 form-check-input">Manual Challan</label>
                                    </div>
                                    ...
                                    <div class="row g-2 mt-2">
                                        <div class="col-6">
                                            ...
                                            <input type="hidden" value="{{ $challan->vehicle_make_id }}"
                                        ...
                                        <div class=" col-6">
                                            ...
                                            <input type="hidden" value="{{ $challan->vehicle_model_id }}"
                                ...
                                {{-- <div style="text-align:left" class="col-md-6 col-12">
                                    ...
                                    <div style="min-height:100px" id="vehicle_details">
                                        <textarea class="form-control" id="vehicle_details_input" name="vehicle">{{ $challan->vehicle }}</textarea>
                                        <input placeholder="KM" type="number" name="km"
                                            value="{{ $challan->km }}" class="form-control">
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="row" id="vehicle_details">
                                        <div class="col-9">
                                            <textarea class="form-control" style="height: 100px" id="vehicle_details_input" name="vehicle">{{ $challan->vehicle }}</textarea>
                                        </div>
                            ...
                            {{-- {{ dd(count($challan->productsChallan)) }} --}}
                            {{-- {{dd($challan->productsChallan);}} --}}
                            {{-- {{dd($challan->productsChallan)}} --}}
                            {{-- {{dd(count($challan->productsChallan) > 0)}} --}}

                            <div class="row" id="product_table"
                                style="{{ count($challan->productsChallan) > 0 ? '' : 'display:none' }}">
                                {{-- {{count($challan->productsChallan) > 0 ? '' : 'display:none' }} --}}
                                <div style="text-align:left" class="col-md-12 col-12">

                                    <span id="add_product" class="btn btn-secondary my-2 float-right  mb-5">Add
                                        Product</span>
                                    {{-- For Company without gst --}}
                                    @if ($challan->gst_flag == 0)
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="thead_content"
                                                ...
                                                <tbody id="tbody_product">
                                                    @forelse ($challan->productsChallan as $key => $product)
                                                        {{-- @php $key++ @endphp --}}
                                                        <tr id="cwg_row_{{ $key }}">
                                                            ...
                                                            <td>
                                                                <select style="min-width:150px !important;"
                                                                    class="form-select cwg_product_description_select"
                                                            ...
                                                            <td>
                                                                ...
                                                                <select style="min-width:80px !important;"
                                                                    ...
                                                                    name="p_unit_{{ $key }}"
                                                                    id="cwg_p_unit_{{ $key }}"
                                                                    onChange="calculateUnit({{ $key }});" required>
                                                ...
                                                <tbody>
                                                    <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                        <td>Discount : <input name="discount" class="form-control"
                                                                ...
                                                                type="text" value="{{ $challan->discount }}"></td>
                                                        <td colspan="2">Total : <input name="total_amount"
                                                                class="form-control" type="text"
                                                                id="product_total_amount"
                                                                value="{{ $challan->total_amount }}" readonly></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div> --}}
                                                    ...
                                                    @forelse ($challan->productsChallan as $key => $product)
                                                        ...
                                                        <tr id="cwg_row_{{ $key }}">
                                                            ...
                                                            <td>
                                                                ...
                                                                {{-- <input type="hidden" style="min-width:80px !important;"
                                                                    name="product_row_counter[${product_counter}]"
                                                    ...
                                                    <tr style="background:rgba(70,70,70,0.1)">
                                                        ...
                                                        <td>
                                                            <input style="min-width:60px !important;"
                                                                ...
                                                                class="form-control" value="{{ $challan->base_amount }}"
                                                                readonly>
                                                        </td>
                                                        <td>
                                                            <input style="min-width:60px !important;"
                                                                ...
                                                                class="form-control"
                                                                value="{{ $challan->total_cgst_percent }}" readonly>
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <input style="min-width:60px !important;"
                                                                ...
                                                                class="form-control"
                                                                value="{{ $challan->total_sgst_percent }}" readonly>
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <input style="min-width:60px !important;"
                                                                ...
                                                                class="form-control"
                                                                value="{{ $challan->total_igst_percent }}" readonly>
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <input style="min-width:60px !important;"
                                                                name="total_amount_all_gst" id="cwg_total_amount_all_gst"
                                                                class="form-control"
                                                                value="{{ $challan->total_amount }}" readonly>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                </tfoot>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                {{ $challan->free_of_charge == 1 ? 'checked' : '' }}
                                                                id="free_of_charge">
                                                    ...
                                                    <td colspan="5" style="background:rgba(70,70,70,0.1)">
                                                        <div>
                                                            ...
                                                            <input class="form-control" id="amt_in_words" type="text"
                                                                name="amt_in_words" value="{{ $challan->amt_in_words }}"
                                                                readonly>
                                                        </div>
                                                    </td>
                                                </tr>
                            ...
                            <div class="row">
                                <div style="text-align:left" class="col-md-12 col-12">
                                    ...
                                    <textarea type="text" name="remark" class="form-control">{{ $challan->remark }}</textarea>
                                </div>
                            </div>
                        </div>
                        @php
                            $product_count = count($challan->productsChallan);
                        @endphp
                        <div class="row">
                            <div class="col-12 d-flex justify-content-start">
                                {{ Form::submit('Edit', ['class' => 'btn btn-primary mr-1 mb-1 me-5']) }}
                                <button type="reset" class="btn btn-primary mr-1 mb-1">Reset</button>
                            </div>
                        </div>
                        <input type="hidden" value="{{ $challan->vehicle_number }}" name="vehicle_number"
                            id="vehicle_number">
                        ...
                        <input type="hidden" value="{{ $challan->gst_flag }}" name="gst_flag" id="gst_flag">
                        <input type="hidden" value="{{ $challan->challan_id }}" name="challan_id" id="challan_id">
                        {{ Form::close() }}
                    </div>
                </div>
            </div>
    ...
    <script>
            ...
            $("#invoice_form").submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        if (data == 'Success') {
                            // window.location.href = "{{ url('admin/challan/') }}";
                            // toastr.info('Page Loaded!');

                            toastr.success(
                                'Have fun!',
                                'Challan Save Succesfully', {
                                    timeOut: 200,
                                    fadeOut: 200,
                                    onHidden: function() {
                ...
                $('#tbody_product').append(`
                    <tr id="cwg_row_${product_counter}">
                        ...
                        <td>
                            ...
                            <input style="min-width:80px !important;" name="hsn_code_${product_counter}" id="cwg_hsn_code_${product_counter}" class="form-control cwg_hsn_code" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">    
                        </td>
                        <td>
                            <input style="min-width:80px !important;" name="quantity_${product_counter}" id="cwg_quantity_${product_counter}" class="form-control cwg_quantity" onChange="getCWGAmount(${product_counter});" required>    
                        </td>
                        <td>
                            <select style="min-width:80px !important;" class="form-select unit_select_input" name="p_unit_${product_counter}" id="cwg_p_unit_${product_counter}" onChange="calculateUnit(${product_counter})" required>
                            </select>
                        </td>
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="orignal_amt_${product_counter}" id="cwg_orignal_amt_${product_counter}" class="form-control cwg_orignal_amt" onChange="getorignalamount(${product_counter})" readonly>    
                        </td>
                        <td>
                            <input style="min-width:80px !important;" name="discount_${product_counter}" id="cwg_discount_${product_counter}" class="form-control cwg_discount" onChange="getDiscountedAmount(${product_counter})" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">    
                        </td>
                        <td>
            ...
            `);
                ...
                $('#cwg_tbody_product').append(`
                    <tr id="cwg_row_${product_counter}">
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="quantity_${product_counter}" id="cwg_quantity_${product_counter}" class="form-control cwg_quantity" onChange="getCWGAmount(${product_counter});" onChange="calculateUnit(${product_counter});" required>    
                        </td>
                        <td>
                            <select style="min-width:80px !important;" class="form-select unit_select_input" name="p_unit_${product_counter}" id="cwg_p_unit_${product_counter}" onChange="calculateUnit(${product_counter});" required>
                            </select>
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="amount_${product_counter}" id="cwg_amount_${product_counter}" class="form-control cwg_amount">    
                        </td>
        ...
        function getInputFields(selected) {
            if (selected == 'Cheque') {
                ...
                <div class="col-4">
                    <input type="text" value="{{ $challan->bank_name }}" name="bank_name" placeholder="Enter Bank Name" class=" form-control">
                </div>
                <div class="col-4">
                    <input type="text" value="{{ $challan->cheque_no }}" name="cheque_no" placeholder="Enter Cheque No." class="form-control">
                </div>  
                <div class="col-4">
                    <input type="date" value="{{ $challan->cheque_date }}" name="cheque_date" placeholder="Enter Cheque Date" class=" form-control">
                </div>  
            `);
            } else if (selected == 'Electronic Transaction') {
                $('#payment_method_input_fields').append(`
            <div class="col-8">
                    <input type="text" value="{{ $challan->e_transaction_ref }}" name="e_transaction_ref" placeholder="Enter e-payment reference (eg : Paytm)" class="form-control">
            </div>
            `);
            }
                        ...
                        if (product != null) {
                            Object.entries(product).forEach(entry => {
                                ...
                                if (service_id == '1') {
                                    ...
                                    $(`#cwg_p_unit_${pc}`).attr('required', false);

                                } else {
                                    $(`#cwg_amount_${pc}`).attr('readonly', true);
                                    $(`#cwg_hsn_code_${pc}`).prop('readonly', false);
                                    $(`#cwg_quantity_${pc}`).prop('readonly', false);
                                    $(`#cwg_p_unit_${pc}`).prop('disabled', false);
                                    $(`#rate_${pc}`).prop('readonly', false);
                                    $(`#cwg_orignal_amt_${pc}`).val('');
                                    $(`#cwg_orignal_amt_${pc}`).attr('readonly', true);
                                    $(`#cwg_p_unit_${pc}`).attr('required', true);
