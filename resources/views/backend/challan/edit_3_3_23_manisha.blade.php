    ...
    {{-- <div id="kt_toolbar_container" class="d-flex flex-stack flex-wrap"> --}}
      {{-- <div class=""> --}}
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <a href="{{ route('admin.challan.create') }}" class="btn btn-success my-2"><i class="bx bx-plus"></i>Add</a>
            </div> --}}
            {{-- </div> --}}
    {{-- </div> --}}
    <!--end::Container-->
                  ...
                  <div class="card">
                      <div class="card-body">
                          <div class="row">
                              ...
                              {{-- {{dd($challan)}} --}}
                              <div class="col-md-6 col-12">
                                  <select id="company_select" class="form-select mb-5" name="company_id_select" required>
                                                  ...
                                                  <tbody id="tbody_product">
                                                      @forelse ($challan->productsChallan as $key => $product)
                                                          ...
                                                          <tr id="row_{{ $key }}">
                                                              ...
                                                              <td>
                                                                  <input class="product_amount form-control"
                                                                      id="product_amount" data-id="{{ $key }}"
                                                                      type="text" onchange="getAmount()"
            ...
            `);
                ...
                $('#cwg_tbody_product').append(`
                    <tr id="cwg_row_${product_counter}">
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="rate_${product_counter}" id="cwg_rate_${product_counter}" class="form-control cwg_rate" onChange=getrate"(${product_counter});>    
                        </td>   
                        <td>
