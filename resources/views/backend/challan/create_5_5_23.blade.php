...
@section('content')
    ...
    <div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Create Challan</h4>
        </div>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{ Form::open(['url' => 'admin/challan/store', 'id' => 'invoice_form']) }}
                        @php
                            if (date('m') > 4) {
                        ...
                        <div class="form-body mb-5">
                            ...
                            <div class="row mt-4 mb-5">
                                ...
                                <div class="col-md-9" style="display:none" id="customer">
                                    <div class="row">
                                ...
                                <div style="text-align:left" class="col-md-6 col-12">
                                    ...
                                    <div class="row g-5 mt-2">
                                        <div class="col-6">
                                            ...
                                            {{ Form::select('vehicle_make_id', ['' => 'Select a Vehicle Make'], null, ['class' => 'form-select', 'id' => 'vehicle_make_id']) }}
                                        </div>
                                        <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-start mt-5">
                                {{ Form::submit('Save', ['class' => 'btn btn-primary mr-1 me-1']) }}
    ...
    <script>
        ...
        function getDiscountedAmount(pc) {
            ...
            if (company_with_gst == '1') {
                ...
                // var discounted_amount = (amount - discount_percent);
                // console.log('DISS', discounted_amount);
