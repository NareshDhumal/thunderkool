                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 service_hide">
                                        <div class="form-label-group mb-5">
                                            ...
                                            {{ Form::number('product_rate', null, ['class' => 'form-control', 'placeholder' => 'Enter Rate', 'id' => 'rate','min'=> 0]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 service_hide">
                                        <div class="form-label-group mb-5">
                                            ...
                                            {{ Form::number('product_stock', null, ['class' => 'form-control product_stock', 'placeholder' => 'Enter Stock', 'id' => 'stock','min'=> 0]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 service_hide">
                                        <div class="form-label-group mb-5">
                                            ...
                                            {{ Form::select('product_unit', $unit, null, ['class' => 'form-select', 'id' => 'product_unit']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 service_hide">
                                        <div class="form-label-group mb-5">
                                            ...
                                            {{ Form::select('gst_percent', $gst_percent, null, ['class' => 'form-select', 'id' => 'gst' ,'placeholder' => 'Select Gst %']) }}
                                        </div>
                                    </div>
