...
@section('content')
    <table class="table-bordered tbl-one" cellpadding="5" style="margin: 0px 20px">
        <tr>
        ...
        <tr>
            <table class="product_table table-bordered" cellpadding="5" style="margin: 0px 20px">
    ...
    <table class="footer_table printable table-bordered" cellpadding="5" style="margin: 0px 20px">
        <tr>
            ...
            <td colspan="5"><b>Free of Charge :</td>
        </tr>
        <tr>
