                                    ...
                                    <div class="row g-2 mt-2">
                                        <div class="col-6">
                                            {{ Form::select(
                                                ...
                                                null,
                                                ['class' => 'form-select', 'id' => 'vehicle_make_id'],
                                            ) }}
                                        </div>
                                        <div class="col-6">
                                            {{ Form::select(
                                                ...
                                                null,
                                                ['class' => 'form-select', 'id' => 'vehicle_model_id'],
                                            ) }}
                                        </div>
                                    </div>
                                </div>
        ...
        $(document).ready(function() {
            ...
            if (company_with_gst == 1 || company_with_gst == 0) {
                    ...
                    <tr id="cwg_row_${product_counter}">
                        <td>
                            <select style="min-width:150px !important;"s class="form-select" name="Row[${product_counter}][product_description]" id="cwg_product_description_input_${product_counter}" onChange="getProduct(${product_counter});">
                            </select>
                        </td>
                        <td>
                            <input style="min-width:80px !important;" name="Row[${product_counter}][hsn]" id="cwg_hsn_code_${product_counter}" class="form-control cwg_hsn_code">    
                        </td>
                        <td>
                            <input style="min-width:80px !important;" name="Row[${product_counter}][quantity]" id="cwg_quantity_${product_counter}" class="form-control cwg_quantity" onChange="getCWGAmount(${product_counter});">    
                        </td>
                        <td>
                            <select style="min-width:80px !important;" class="form-select unit_select_input" name="Row[${product_counter}][unit]" id="cwg_p_unit_${product_counter}" onChange="calculateUnit(${product_counter})">
                            </select>
                        </td>
                        <td>
                            <input style="min-width:80px !important;" name="Row[${product_counter}][rate]" id="cwg_rate_${product_counter}" class="form-control cwg_rate" onChange="getrate(${product_counter})">    
                        </td>   
                        
                        <td hidden>
                            <input style="min-width:80px !important;" name="Row[${product_counter}][stock]" id="product_stock_${product_counter}" class="form-control product_stock">    
                        </td>   

                        <td>
                            <input style="min-width:80px !important;" name="Row[${product_counter}][amount]" id="cwg_amount_${product_counter}" class="form-control cwg_amount" readonly>    
                        </td>
                        <td>
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="Row[${product_counter}][discount]" id="cwg_discount_${product_counter}" class="form-control cwg_discount" onChange="getDiscountedAmount(${product_counter})">    
                        </td>
                        <td>
                            <input style="min-width:80px !important;" name="Row[${product_counter}][totalamount]" id="cwg_total_amount_${product_counter}" class="form-control cwg_total_amount" readonly>    
                        </td>
                        <td style="text-align:center;">
                            <i onClick="removeProduct(${product_counter})" style="font-size:1.5em;cursor:pointer" class="far fa-minus-square text-danger"></i>
                        </td>
