...
<div class="toolbar row py-5 py-lg-10" id="kt_toolbar">
    ...
    {{-- <div id="kt_toolbar_container" class="d-flex flex-stack flex-wrap"> --}}
      {{-- <div class=""> --}}
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h4 class="text-white fw-bolder fs-2qx me-5">Create Invoice</h4>
        </div>       
                {{-- @can('Create Admin Users') --}}
            {{-- <div class=" col-lg-6 col-md-6 col-sm-12 text-end">
            <a href="{{ route('admin.products.create') }}" class="btn btn-success my-2"><i class="bx bx-plus"></i>Add</a>
            </div> --}}
            {{-- </div> --}}
    {{-- </div> --}}
    <!--end::Container-->
  ...
  <section class="db-section admin-from">
      <div class="content">
                          ...
                          <div class="form-body">
                              ...
                              <div class="row">
                                  <div style="text-align:left" class="col-md-12 col-12">
                                      ...
                                      <textarea type="text" name="remark" class="form-control mb-5"></textarea>
                                  </div>
                              </div>
                          </div>
                          <div class="row">
        ...
        $(document).ready(function() {
            ...
            if (company_with_gst == 1 || company_with_gst == 0) {
                    ...
                    <tr id="cwg_row_${product_counter}">
                        <td>
                            <select style="min-width:150px !important;"s class="form-select" name="products[${product_counter}][product_description]" id="cwg_product_description_input_${product_counter}" onChange="getProduct(${product_counter});">
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <input style="min-width:80px !important;" name="products[${product_counter}][amount]" id="cwg_amount_${product_counter}" class="form-control cwg_amount" readonly>    
                        </td>
                        <td>
