                                ...
                                <div style="text-align:left" class="col-md-6 col-12">
                                    ...
                                    <div class="row g-5 mt-2">
                                        <div class="col-6">
                                            ...
                                            {{ Form::select('vehicle_make_id', ['' => 'Select a VehicleMake'], null, [
                                                'class' => 'form-select',
                                                'id' => 'vehicle_make_id',
                                            ]) }}
                                        </div>
            ...
            // `);
                ...
                if (company_with_gst == 1 || company_with_gst == 0) {
                    ...
                    <tr id="cwg_row_${product_counter}">
                        ...
                        <td>
                            <select style="min-width:150px !important;"s class="form-select cwg_product_description_input" name="products[${product_counter}][product_description]" id="cwg_product_description_input_${product_counter}"
                            data-row_id="${product_counter}"  onChange="getProduct(${product_counter});">
                            </select>
                        </td>`;
                        ...
                        if (products != null) {
                            ...
                            `);
                                Object.entries(products).forEach(entry => {
                                    ...
                                    $(`#cwg_product_description_input_${product_counter}`).append(`
                                    <option value="${value.product_id}"  data-service_id="${value.service_id}" data-unit="${value.product_unit}">${value.product_name}</option>
