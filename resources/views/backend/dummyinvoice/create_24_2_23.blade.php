        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {{ Form::open(array('url' => 'admin/dummyinvoice/store','id'=>'invoice_form')) }}
                    @csrf
                    {{-- <div class="row">
                        <div class="col-6">
                            <h4 class="card-title">Create Invoice</h4>
                                        ...
                                        <tbody>
                                            <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                <td>Discount : <input name="discount" class="form-control"
                                                        onchange="getAmount()" id="product_discount" type="text"></td>
                                                <td colspan="2">Total : <input name="total_amount" class="form-control"
                                                        type="text" id="product_total_amount" readonly></td>
                                            </tr>
                                        ...
                                        <tbody>
                                            <tr id="cwg_total" style="background:rgba(70,70,70,0.1)">
                                                <td>
                                                    ...
                                                    <input style="min-width:60px !important;" name="total_amount_all"
                                                        id="cwg_total_amount_all_footer" class="form-control" readonly>
                                                </td>
                                                <td>
                                                    <p>IGST</p>
                                                ...
                                                <td>
                                                    ...
                                                    <input name="cwg_total_amount" class="form-control" type="text"
                                                        id="cwg_total_amount_all_gst_footer" readonly>
                                                </td>
                                            </tr>
                                            ...
                                            <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                <td id="payment_method_cell" colspan="4">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="form-check me-4">
                                                            {{ Form::radio('payment_method', 'Electronic
                                                            Transaction',false,['id'=>'electronic_transaction','class'=>'form-check-input'])
                                                            }}
...
<script>
            ...
            if (company_with_gst == 1 || company_with_gst == 0) {
                ...
                $('#tbody_product').append(`
                    <tr id="row_${product_counter}">
                        <td><input type="text" class="form-control" name="product[${product_counter}][product_description]"></td>
                        <td><input class="product_amount form-control" id="product_amount" data-id="${product_counter}" type="text" onchange="getAmount()" name="product[${product_counter}][product_amount]"></td>
            ...
            $.ajax({
                ...
                , success: function(data) {
                    ...
                    if (Object.keys(response).length > 0) {
                        ...
                        // `);
                            let a = "Name: "+response.company_name+'\n'+"Address: "+response.company_address;
                        $('#company_info').text(a);
                        $('#customer').show();
                    }
                }
    ...
    function getInputFields(selected) {
        if (selected == 'Cheque') {
            ...
            $('#payment_method_input_fields').append(`
            <div class="col-8">
                    <input type="text" name="e_transaction_ref" placeholder="Enter e-payment reference (eg : Paytm)" class="form-control">
            </div>
            `);
        }
    }
