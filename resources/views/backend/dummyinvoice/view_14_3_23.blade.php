        ...
        {{-- <form method="post"> --}}
            <div id="table-wraper">
                <table class="table-bordered tbl-datatable" cellpadding="5" width="100%" style="">
                    <tr>
                        <td colspan="3" align="center"><img src="{{asset('/storage/app').$company_details->company_logo}}"
                                width="200"></td>
                        <td style="width:400px" colspan="8" class="company_nm" align="center">
                            <h4 style="margin-bottom:10px;font-size:17px;"> {{$company_details->company_name}}</h4>
                            <h5 style="font-size:14px;">{{$company_details->company_address}}<br>
                                ...
                                Branch Name : {{ $company_details->cm_branch_name}}
                            </h5>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td colspan="14" class="bold">Invoice No: {{ $company_details->company_short_name . $invoice_data['invoice_no']}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="text-transform:uppercase;">Chassis No : {{ $vehicle->chassis_no ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" rowspan="2" style="text-transform:uppercase;">
                            ...
                            GST NO : </td>
                        <td colspan="4" style="text-transform:uppercase;">Vehicle No :  {{ $invoice_data['vehicle_number'] }}</span></td>
                        <td colspan="4" style="text-transform:uppercase;">Serial No :  {{ $vehicle->serial_no ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-transform:uppercase;">Model :   {{ $vehicle_model->vehicle_model_name ?? '-' }}</span>
                        </td>
                        <td colspan="4" style="text-transform:uppercase;">Cab No :  {{ $vehicle->cab_no ?? '-' }}</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" style="text-transform:uppercase;">Loco No : {{ $vehicle->loco_no ?? '-' }}</td>
                    </tr>
                    <tr>
                        @if($invoice_data['gst_flag']  == 1)
                    <tr class="">
                    ...
                    <tr class="border_row">
                        ...
                        <td align="right" class="bold" colspan="3">{{ $invoice_data['total_amount_all']}}</td>
                    </tr>
                    <tr>
                        <td colspan="11" style="text-align: right;" class="bold">Total (Without Tax)
                        </td>
                        <td align="right" colspan="3" style="width:10mm;border-bottom:1px solid #000;" class="bold">
                    ...
                    @endphp --}}
                    <tr>
                        <td colspan="10" align="left"><b> Payment Mode :{{$invoice_data['payment_method']}}</b>
                    ...
                    <tr>
                        ...
                        <td colspan="6" align="center"><strong>{{"FOR ".$company_details->company_name}}</strong></td>
                    </tr>
                    <tr>
