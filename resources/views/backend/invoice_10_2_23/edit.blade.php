        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <select id="company_select" class="form-select" name="company_id_select" required>
                                ...
                                <option {{ $invoice->company_id == $key ? 'selected' : '' }} value="{{$key}}">
                                    {{$company}}
                                </option>
                                @endforeach
                            </select>
                    ...
                    {{ Form::model($invoice,array('url' => 'admin/invoice/update','id'=>'invoice_form')) }}
                    @csrf
                    {{-- <div class="row">
                        <div class="col-6">
                    ...
                    <input type="hidden" id="company_id" value="{{$invoice->company_id}}" name="company_id" class="form-control">
                    <div class="form-body">
                        <div class="row">
                        ...
                        <div class="row mt-4">
                            ...
                            if($last_invoice) {
                            $last_invoice_id = '000'.$last_invoice[0]['invoice_id'] + 1;
                            // dd('hello');
                            }
                            // dd($last_invoice_id);
                            @endphp
                            ...
                            <div style="text-align:left" class="col-md-6 col-12">
                                ...
                                <div style="min-height:100px" id="invoice_no">
                                    <input type="text" id="invoice_no" name="invoice_no" value="{{$invoice->invoice_no}}" class="form-control disabled" readonly>
                                </div>
                            </div>
                            <div style="text-align:left" class="col-md-6 col-12">
                                <p style="font-weight:600">Date Of Issue</p>
                                <div style="min-height:100px" id="date_of_issue">
                                    <input value="{{$invoice->date_of_issue}}" type="date" id="date_of_issue_input" name="date_of_issue" class="form-control">
                                    {{-- <input type="date" /> --}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="vehicle_container" style="display:none">
                            <div style="text-align:left" class="col-md-6 col-12">
                                <div class="d-flex align-items-center">
                                    <label class="d-flex align-items-center"><input type="checkbox" id="manual_invoice" {{ $invoice->manual_invoice == '1'? 'checked': '' }} name="manual_invoice" value="1" class="me-2 form-check-input">Manual Invoice</label>
                                </div>

                                <div class="row g-2 mt-2">
                                    <div class="col-6">
                                        {{Form::select('vehicle_make_id', [],null,['class'=>'form-select','id'=>'vehicle_make_id','placeholder'=>
                                        'Select a Vehicle Make'])}}
                                        <input type="hidden" value="{{$invoice->vehicle_make_id}}" id="selected_vehicle_make">
                                    </div>
                                    <div class=" col-6">
                                        {{Form::select('vehicle_model_id',[],null,['class'=>'form-select','id'=>'vehicle_model_id','placeholder'=>
                                        'Select a Vehicle Make'])}}
                                        <input type="hidden" value="{{$invoice->vehicle_model_id}}" id="selected_vehicle_model">
                                    </div>
                                </div>
                            </div>
                            <div style="text-align:left" class="col-md-6 col-12">
                                ...
                                <div style="min-height:100px" id="vehicle_details">
                                    ...
                                    <input placeholder="KM" type="number" name="km" value="{{$invoice->km}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="product_table" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}">
                            ...
                            <div style="text-align:left" class="col-md-12 col-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="thead_content" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody id="tbody_product">
                                            ...
                                            <tr id="row_{{$key}}">
                                                <td>
                                                    <input type="text" class="form-control" name="product_description_{{$key}}" value="{{ $product->product_description }}">
                                                </td>
                                                <td>
                                                    <input class="product_amount form-control" id="product_amount" data-id="{{$key}}" type="text" onchange="getAmount()" name="product_amount_{{$key}}" value="{{ $product->product_amount }}">

                                                    <input type="hidden" name="product_invoice_id_{{$key}}" value="{{$product->product_invoice_id}}">
                                                </td>
                                                <td style="text-align:center;">
                                                    <i onClick="removeProduct({{$key}})" style="font-size:1.5em;cursor:pointer" class="far fa-minus-square text-danger"></i>
                                                </td>
                                            </tr>
                                            @empty
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}" id="tfoot_content">
                                        <tbody>
                                            <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                <td>Discount : <input name="discount" class="form-control" onchange="getAmount()" id="product_discount" type="text" value="{{ $invoice->discount }}"></td>
                                                <td colspan="2">Total : <input name="total_amount" class="form-control" type="text" id="product_total_amount" value="{{ $invoice->total_amount }}" readonly></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="cwg_thead_content" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}">
                                        <thead>
                                            <tr>
                                                <th scope="col">Product Description</th>
                                        ...
                                        <tbody id="cwg_tbody_product">
                                            ...
                                            <tr id="cwg_row_{{$key}}">
                                                <td>
                                                    <select style="min-width:150px !important;" s class="form-select product_select_input" name="product_description_{{$key}}" id="cwg_product_description_input_{{$key}}" onChange="getProduct({{$key}});">
                                                        ...
                                                        @endphp
                                                        <option {{$product->product_id == $p->product_id ? 'selected' : '' }} value="{{$p->product_id}}">{{$p->product_name}}</option>
                                                ...
                                                <td>
                                                    <input style="min-width:80px !important;" name="hsn_code_{{$key}}" id="cwg_hsn_code_{{$key}}" class="form-control cwg_hsn_code" value="{{ $product->hsn_code }}">
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="quantity_{{$key}}" id="cwg_quantity_{{$key}}" class="form-control cwg_quantity" onChange="getCWGAmount({{$key}});" value="{{ $product->quantity }}">
                                                </td>
                                                {{-- {{dd($units)}} --}}
                                                <td>
                                                    <select style="min-width:80px !important;" class="form-select unit_select_input" name="p_unit_{{$key}}" id="cwg_p_unit_{{$key}}">
                                                        @foreach($units as $unit)
                                                        <option {{$unit->P_unit_id == $product->p_unit ? 'selected' : '' }} value="{{$product->p_unit}}">{{$product->p_unit}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="rate_{{$key}}" id="cwg_rate_{{$key}}" class="form-control cwg_rate" value="{{ $product->rate }}" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="amount_{{$key}}" value="{{ $product->product_amount }}" id="cwg_amount_{{$key}}" class="form-control cwg_amount" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="cgst_percent_{{$key}}" value="{{ $product->cgst_percent }}" id="cwg_cgst_percent_{{$key}}" class="form-control cwg_cgst_percent" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="cgst_amount_{{$key}}" value="{{ $product->cgst_amount }}" id="cwg_cgst_amount_{{$key}}" class="form-control cwg_cgst_amount" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="sgst_percent_{{$key}}" value="{{ $product->sgst_percent }}" id="cwg_sgst_percent_{{$key}}" class="form-control cwg_sgst_percent" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="sgst_amount_{{$key}}" value="{{ $product->sgst_amount }}" id="cwg_sgst_amount_{{$key}}" class="form-control cwg_sgst_amount" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="igst_percent_{{$key}}" value="{{ $product->igst_percent }}" id="cwg_igst_percent_{{$key}}" class="form-control cwg_igst_percent" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="igst_amount_{{$key}}" value="{{ $product->igst_amount }}" id="cwg_igst_amount_{{$key}}" class="form-control cwg_igst_amount" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="discount_{{$key}}" id="cwg_discount_{{$key}}" value="{{ $product->discount }}" class="form-control cwg_discount" onChange="getDiscountedAmount({{$key}})">
                                                </td>
                                                <td>
                                                    <input style="min-width:80px !important;" name="total_amount_{{$key}}" value="{{ $product->product_total_amount }}" id="cwg_total_amount_{{$key}}" class="form-control cwg_total_amount" readonly>
                                        ...
                                        <tfoot>
                                            <tr style="background:rgba(70,70,70,0.1)">
                                                ...
                                                <td></td>
                                                <td>
                                                    <input style="min-width:60px !important;" name="total_quantity" id="cwg_total_quantity" class="form-control" value="{{ $total_quantity }}" readonly>
                                                </td>
                                                <td></td>
                                                <td>
                                                    {{-- <input style="min-width:60px !important;" name="total_rate_all" id="cwg_total_rate_all" class="form-control" readonly> --}}
                                                </td>
                                                <td>
                                                    <input style="min-width:60px !important;" name="total_amount_all" id="cwg_total_amount_all" class="form-control" value="{{ $invoice->base_amount }}" readonly>
                                                </td>
                                                <td>
                                                    <input style="min-width:60px !important;" name="total_cgst_all" id="cwg_total_cgst_all" class="form-control" value="{{ $invoice->total_cgst_percent }}" readonly>
                                                </td>
                                                <td></td>
                                                <td>
                                                    <input style="min-width:60px !important;" name="total_sgst_all" id="cwg_total_sgst_all" class="form-control" value="{{ $invoice->total_sgst_percent }}" readonly>
                                                </td>
                                                <td></td>
                                                <td>
                                                    <input style="min-width:60px !important;" name="total_igst_all" id="cwg_total_igst_all" class="form-control" value="{{ $invoice->total_igst_percent }}" readonly>
                                                </td>
                                                <td></td>
                                                <td></td>
                                                <td>
                                                    <input style="min-width:60px !important;" name="total_amount_all_gst" id="cwg_total_amount_all_gst" class="form-control" value="{{ $invoice->total_amount }}" readonly>
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tfoot>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}" id="cwg_tfoot_content">
                                        <tbody>
                                            <tr id="cwg_total" style="background:rgba(70,70,70,0.1)">
                                                <td>
                                                    <p>Total Amount without Tax</p>
                                                    <input style="min-width:60px !important;" name="total_amount_all" id="cwg_total_amount_all_footer" class="form-control" value="{{ $invoice->base_amount }}" readonly>
                                                </td>
                                                <td>
                                                    <p>IGST</p>
                                                    <input style="width:60px !important;" name="total_igst_all" id="cwg_total_igst_all_footer" class="form-control" value="{{ $invoice->total_igst_percent }}" readonly>
                                                </td>
                                                <td>
                                                    <p>CGST</p>
                                                    <input style="width:60px !important;" name="total_cgst_all" id="cwg_total_cgst_all_footer" class="form-control" value="{{ $invoice->total_cgst_percent }}" readonly>
                                                </td>
                                                <td>
                                                    <p>SGST</p>
                                                    <input style="width:60px !important;" name="total_sgst_all" id="cwg_total_sgst_all_footer" class="form-control" value="{{ $invoice->total_sgst_percent }}" readonly>
                                                </td>
                                                <td>
                                                    <p>Grand Total (With GST)</p>
                                                    <input name="cwg_total_amount" class="form-control" type="text" id="cwg_total_amount_all_gst_footer" value="{{ $invoice->total_amount }}" readonly>
                                                </td>
                                            </tr>
                                ...
                                @endif
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="{{count($invoice->productsInvoice) > 0 ? '' : 'display:none' }}" id="product_common_content">
                                        <tbody>
                                            <tr id="total" style="background:rgba(70,70,70,0.1)">
                                                ...
                                                <td colspan="2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="free_of_charge" value="1" {{$invoice->free_of_charge == 1 ? 'checked' : ''}} id="free_of_charge">
                                            ...
                                            <tr>
                                                <td colspan="5" style="background:rgba(70,70,70,0.1)">
                                                    <div>
                                                        ...
                                                        <input class="form-control" id="amt_in_words" type="text" name="amt_in_words" value="{{ $invoice->amt_in_words }}" readonly>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    @php
                    $product_count = count($invoice->productsInvoice) - 1;
                    @endphp
                    <div class="row">
                        <div class="col-12 d-flex justify-content-start">
                            {{ Form::submit('Edit', array('class' => 'btn btn-primary mr-1 mb-1')) }}
                            <button type="reset" class="btn btn-light-secondary mr-1 mb-1">Reset</button>
                        </div>
                    </div>
                    <input type="hidden" value="{{ $invoice->vehicle_number }}" name="vehicle_number" id="vehicle_number">
                    <input type="hidden" value="{{ $product_count }}" name="product_counter" id="product_counter">
...
<script>
        ...
        if (company_with_gst == 0) {
            ...
            $('#tbody_product').append(`
                    <tr id="row_${product_counter}">
                        <td><input type="text" class="form-control" name="product_description_${product_counter}"></td>
                        <td><input class="product_amount form-control" id="product_amount" data-id="${product_counter}" type="text" onchange="getAmount()" name="product_amount_${product_counter}"></td>
                        <td style="text-align:center;"><i onClick="removeProduct(${product_counter})" style="font-size:1.5em;cursor:pointer" class="far fa-minus-square text-danger"></i></td>
                    </tr>
            `);
        } else {
            // With GST
            ...
            $('#cwg_tbody_product').append(`
                    <tr id="cwg_row_${product_counter}">
                        <td>
                            <select style="min-width:150px !important;"s class="form-select product_select_input" name="product_description_${product_counter}" id="cwg_product_description_input_${product_counter}" onChange="getProduct(${product_counter});">
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <select style="min-width:80px !important;" class="form-select unit_select_input" name="p_unit_${product_counter}" id="cwg_p_unit_${product_counter}">
                            </select>
                        </td>
                        <td>
    ...
    function getCWGAmount(pc) {
        var quantity_value = parseInt($(`#cwg_quantity_${pc}`).val());
        ...
        var amount = parseInt(quantity_value) * parseInt($(`#cwg_rate_${pc}`).val());
    ...
    function getTotalAmount() {
        ...
        $('#cwg_total_amount_all').val(cwg_total_amount_all);
        ...
        // Grand total
        $(`#cwg_total_amount_all_footer`).val(cwg_total_amount_all);
