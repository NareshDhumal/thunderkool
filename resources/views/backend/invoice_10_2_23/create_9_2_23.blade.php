                    ...
                    <div class="form-body">
                        <div class="row">
                            <div style="text-align:left" class="col-md-6 col-12">
                                ...
                                <div id="company_logo">
                                    <p style="font-size:0.8em;color: rgb(158, 158, 158)">Select a Company to fill the data</p>
                                </div>
                            </div>
                            <div style="text-align:left" class="col-md-6 col-12">
                        ...
                        <div class="row" id="vehicle_container" style="display:none">
                            <div style="text-align:left" class="col-md-6 col-12">
                                <div class="d-flex align-items-center">
                                    <label class="d-flex align-items-center"><input type="checkbox" id="manual_invoice" value="1" name="manual_invoice" class="me-2 form-check-input">Manual Invoice</label>
                                </div>
