                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <label>Date *</label>
                                    <input class="form-control" type="date" name="dated" id="dated" value="" required>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="form-select" name="company_id" id="company_id">
                                        ...
                                        @foreach ($company_name as $company_id => $company_names)
                                            <option value="{{ $company_id }}">{{ $company_names }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="payment_option">
                                                ...
                                                <div><span id="bank_name"></span></div>
                                                <div><input class="form-control" type="text" name="bank_name"
                                                        id="bank_name_feild" style="display: none;"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-label-group">
                                                ...
                                                {{ Form::select('company_id', $company_name, Request::get('company_id'), ['class' => 'form-select', 'placeholder' => 'Select Company', 'id' => 'company_id']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        @if (isset($daily_expenses) && count($daily_expenses) > 0)
                                            ...
                                            @foreach ($daily_expenses as $expenses)
                                                @php
                                                    $company_name = Company::where('company_id', $expenses->company_id)->first();
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="noexcel"><a class="btn btn-sm btn-danger"
