                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group" >
                                        ...
                                        {{ Form::select('type', ['normal question' => 'normal question', 'textarea' => 'textarea', 'checkbox' => 'checkbox' ,'radio' => 'radio' , 'rating' => 'rating'], null, ['class' => 'form-control', 'id' => 'questiontype', 'placeholder' => 'Select Question Type', 'required' => true]) }}
                                    </div>
                                </div>
                            </div>
